...
- [x] D5 perf: bundle diet + CI size budget (plan 044) — horizons ephemeris lazy-loaded (1,321→1,218 kB raw), size-budget gate in build, SW offline fix (cf568cf + 0759ca9)
