...
- [ ] fix(render): Milky Way narrower + purplish (user photo ref) — plan `plans/036-mw-narrow-purple.md`. Parameterize `bake_milkyway.py` (`--core-sigma/--halo-sigma/--sample-sigma/--purple`); re-bake `--core-sigma 2.8 --halo-sigma 5.5 --sample-sigma 3.8 --purple --star-scale 0.10 --band-scale 0.55`. 1% halo FWHM 12.6→10.2° (19%) / 12.9→9.3° (28%) at gal-long 90°/135°; hue blue-white→violet/magenta. `MILKYWAY_TINT` unchanged (0.3).
