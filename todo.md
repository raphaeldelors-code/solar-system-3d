...
- [ ] F1 fix(ui): cap panel height so a picked body's info card never clips — plan `plans/043-panel-polish-pass.md`
- [ ] F2 style(ui): disambiguate the two Date labels (Now vs Jump to) — plan 043
- [ ] F3 style(ui): theme the native form controls (select + checkboxes) — plan 043
- [ ] F4 style(ui): section headers + a real title type scale — plan 043
- [ ] F5 style(ui): disambiguate button tiers + full-width events list — plan 043
