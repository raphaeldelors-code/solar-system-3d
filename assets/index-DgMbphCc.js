...
void main() {
	...
	`}function W_(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const c=o.mapping,l=c===gl||c===_l,u=c===Js||c===Qs;if(l||u){let d=e.get(o);const h=d!==void 0?d.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==h)return t===null&&(t=new Vd(n)),d=l?t.fromEquirectangular(o,d):t.fromCubemap(o,d),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),d.texture;if(d!==void 0)return d.texture;{const f=o.image;return l&&f&&f.height>0||u&&f&&s(f)?(t===null&&(t=new Vd(n)),d=l?t.fromEquirectangular(o):t.fromCubemap(o),d.texture.pmremVersion=o.pmremVersion,e.set(o,d),o.addEventListener("dispose",r),d.texture):null}}}return o}function s(o){let c=0;const l=6;for(let u=0;u<l;u++)o[u]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function X_(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&Xs("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function Y_(n,e,t,i){const s={},r=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const _=h.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)e.remove(_[m])}h.removeEventListener("dispose",a),delete s[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function c(d){const h=d.attributes;for(const g in h)e.update(h[g],n.ARRAY_BUFFER);const f=d.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)e.update(_[m],n.ARRAY_BUFFER)}}function l(d){const h=[],f=d.index,g=d.attributes.position;let _=0;if(f!==null){const v=f.array;_=f.version;for(let x=0,E=v.length;x<E;x+=3){const R=v[x+0],T=v[x+1],D=v[x+2];h.push(R,T,T,D,D,R)}}else if(g!==void 0){const v=g.array;_=g.version;for(let x=0,E=v.length/3-1;x<E;x+=3){const R=x+0,T=x+1,D=x+2;h.push(R,T,T,D,D,R)}}else return;const m=new(Kf(h)?$f:Qf)(h,1);m.version=_;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&l(d)}else l(d);return r.get(d)}return{get:o,update:c,getWireframeAttribute:u}}function j_(n,e,t){let i;function s(h){i=h}let r,a;function o(h){r=h.type,a=h.bytesPerElement}function c(h,f){n.drawElements(i,f,r,h*a),t.update(f,i,1)}function l(h,f,g){g!==0&&(n.drawElementsInstanced(i,f,r,h*a,g),t.update(f,i,g))}function u(h,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,f,0,r,h,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,i,1)}function d(h,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)l(h[p]/a,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(i,f,0,r,h,0,_,0,g);let p=0;for(let v=0;v<g;v++)p+=f[v];for(let v=0;v<_.length;v++)t.update(p,i,_[v])}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u,this.renderMultiDrawInstances=d}function K_(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(r/3);break;case n.LINES:t.lines+=o*(r/2);break;case n.LINE_STRIP:t.lines+=o*(r-1);break;case n.LINE_LOOP:t.lines+=o*r;break;case n.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function q_(n,e,t){const i=new WeakMap,s=new tt;function r(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let h=i.get(o);if(h===void 0||h.count!==d){let S=function(){H.dispose(),i.delete(o),o.removeEventListener("dispose",S)};var f=S;h!==void 0&&h.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],v=o.morphAttributes.normal||[],x=o.morphAttributes.color||[];let E=0;g===!0&&(E=1),_===!0&&(E=2),m===!0&&(E=3);let R=o.attributes.position.count*E,T=1;R>e.maxTextureSize&&(T=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const D=new Float32Array(R*T*4*d),H=new Zf(D,R,T,d);H.type=Ln,H.needsUpdate=!0;const b=E*4;for(let C=0;C<d;C++){const k=p[C],O=v[C],Y=x[C],W=R*T*4*C;for(let V=0;V<k.count;V++){const j=V*b;g===!0&&(s.fromBufferAttribute(k,V),D[W+j+0]=s.x,D[W+j+1]=s.y,D[W+j+2]=s.z,D[W+j+3]=0),_===!0&&(s.fromBufferAttribute(O,V),D[W+j+4]=s.x,D[W+j+5]=s.y,D[W+j+6]=s.z,D[W+j+7]=0),m===!0&&(s.fromBufferAttribute(Y,V),D[W+j+8]=s.x,D[W+j+9]=s.y,D[W+j+10]=s.z,D[W+j+11]=Y.itemSize===4?s.w:1)}}h={count:d,texture:H,size:new ae(R,T)},i.set(o,h),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const _=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(n,"morphTargetBaseInfluence",_),c.getUniforms().setValue(n,"morphTargetInfluences",l)}c.getUniforms().setValue(n,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(n,"morphTargetsTextureSize",h.size)}return{update:r}}function Z_(n,e,t,i){let s=new WeakMap;function r(c){const l=i.render.frame,u=c.geometry,d=e.get(c,u);if(s.get(d)!==l&&(e.update(d),s.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const h=c.skeleton;s.get(h)!==l&&(h.update(),s.set(h,l))}return d}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}class rp extends St{constructor(e,t,i,s,r,a,o,c,l,u=Ws){if(u!==Ws&&u!==tr)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===Ws&&(i=ss),i===void 0&&u===tr&&(i=er),super(null,s,r,a,o,c,u,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:zt,this.minFilter=c!==void 0?c:zt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const ap=new St,jd=new rp(1,1),op=new Zf,cp=new Og,lp=new np,Kd=[],qd=[],Zd=new Float32Array(16),Jd=new Float32Array(9),Qd=new Float32Array(4);function fr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=Kd[s];if(r===void 0&&(r=new Float32Array(s),Kd[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function yt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Et(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function qo(n,e){let t=qd[e];t===void 0&&(t=new Int32Array(e),qd[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function J_(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Q_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2fv(this.addr,e),Et(t,e)}}function $_(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(yt(t,e))return;n.uniform3fv(this.addr,e),Et(t,e)}}function ev(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4fv(this.addr,e),Et(t,e)}}function tv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,i))return;Qd.set(i),n.uniformMatrix2fv(this.addr,!1,Qd),Et(t,i)}}function nv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,i))return;Jd.set(i),n.uniformMatrix3fv(this.addr,!1,Jd),Et(t,i)}}function iv(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(yt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Et(t,e)}else{if(yt(t,i))return;Zd.set(i),n.uniformMatrix4fv(this.addr,!1,Zd),Et(t,i)}}function sv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function rv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2iv(this.addr,e),Et(t,e)}}function av(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;n.uniform3iv(this.addr,e),Et(t,e)}}function ov(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4iv(this.addr,e),Et(t,e)}}function cv(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function lv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(yt(t,e))return;n.uniform2uiv(this.addr,e),Et(t,e)}}function uv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(yt(t,e))return;n.uniform3uiv(this.addr,e),Et(t,e)}}function dv(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(yt(t,e))return;n.uniform4uiv(this.addr,e),Et(t,e)}}function hv(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(jd.compareFunction=jf,r=jd):r=ap,t.setTexture2D(e||r,s)}function fv(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||cp,s)}function pv(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||lp,s)}function mv(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||op,s)}function gv(n){switch(n){case 5126:return J_;case 35664:return Q_;case 35665:return $_;case 35666:return ev;case 35674:return tv;case 35675:return nv;case 35676:return iv;case 5124:case 35670:return sv;case 35667:case 35671:return rv;case 35668:case 35672:return av;case 35669:case 35673:return ov;case 5125:return cv;case 36294:return lv;case 36295:return uv;case 36296:return dv;case 35678:case 36198:case 36298:case 36306:case 35682:return hv;case 35679:case 36299:case 36307:return fv;case 35680:case 36300:case 36308:case 36293:return pv;case 36289:case 36303:case 36311:case 36292:return mv}}function _v(n,e){n.uniform1fv(this.addr,e)}function vv(n,e){const t=fr(e,this.size,2);n.uniform2fv(this.addr,t)}function xv(n,e){const t=fr(e,this.size,3);n.uniform3fv(this.addr,t)}function Mv(n,e){const t=fr(e,this.size,4);n.uniform4fv(this.addr,t)}function Sv(n,e){const t=fr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function yv(n,e){const t=fr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Ev(n,e){const t=fr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function bv(n,e){n.uniform1iv(this.addr,e)}function Tv(n,e){n.uniform2iv(this.addr,e)}function Av(n,e){n.uniform3iv(this.addr,e)}function wv(n,e){n.uniform4iv(this.addr,e)}function Dv(n,e){n.uniform1uiv(this.addr,e)}function Pv(n,e){n.uniform2uiv(this.addr,e)}function Cv(n,e){n.uniform3uiv(this.addr,e)}function Rv(n,e){n.uniform4uiv(this.addr,e)}function Lv(n,e,t){const i=this.cache,s=e.length,r=qo(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),Et(i,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||ap,r[a])}function Iv(n,e,t){const i=this.cache,s=e.length,r=qo(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),Et(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||cp,r[a])}function Hv(n,e,t){const i=this.cache,s=e.length,r=qo(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),Et(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||lp,r[a])}function Uv(n,e,t){const i=this.cache,s=e.length,r=qo(t,s);yt(i,r)||(n.uniform1iv(this.addr,r),Et(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||op,r[a])}function Nv(n){switch(n){case 5126:return _v;case 35664:return vv;case 35665:return xv;case 35666:return Mv;case 35674:return Sv;case 35675:return yv;case 35676:return Ev;case 5124:case 35670:return bv;case 35667:case 35671:return Tv;case 35668:case 35672:return Av;case 35669:case 35673:return wv;case 5125:return Dv;case 36294:return Pv;case 36295:return Cv;case 36296:return Rv;case 35678:case 36198:case 36298:case 36306:case 35682:return Lv;case 35679:case 36299:case 36307:return Iv;case 35680:case 36300:case 36308:case 36293:return Hv;case 36289:case 36303:case 36311:case 36292:return Uv}}class Ov{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=gv(t.type)}}class Fv{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Nv(t.type)}}class zv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],i)}}}const zc=/(\w+)(\])?(\[|\.)?/g;function $d(n,e){n.seq.push(e),n.map[e.id]=e}function Bv(n,e,t){const i=n.name,s=i.length;for(zc.lastIndex=0;;){const r=zc.exec(i),a=zc.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){$d(t,l===void 0?new Ov(o,n,e):new Fv(o,n,e));break}else{let d=t.map[o];d===void 0&&(d=new zv(o),$d(t,d)),t=d}}}class _o{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);Bv(r,a,this)}}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=i[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&i.push(a)}return i}}function eh(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const kv=37297;let Gv=0;function Vv(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}function Wv(n){const e=Ke.getPrimaries(Ke.workingColorSpace),t=Ke.getPrimaries(n);let i;switch(e===t?i="":e===wo&&t===Ao?i="LinearDisplayP3ToLinearSRGB":e===Ao&&t===wo&&(i="LinearSRGBToLinearDisplayP3"),n){case Hi:case Ko:return[i,"LinearTransferOETF"];case Mt:case bu:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function th(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),s=n.getShaderInfoLog(e).trim();if(i&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Vv(n.getShaderSource(e),a)}else return s}function Xv(n,e){const t=Wv(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function Yv(n,e){let t;switch(e){case Rf:t="Linear";break;case Lf:t="Reinhard";break;case If:t="Cineon";break;case gu:t="ACESFilmic";break;case Hf:t="AgX";break;case Uf:t="Neutral";break;case tg:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Ga=new w;function jv(){Ke.getLuminanceCoefficients(Ga);const n=Ga.x.toFixed(4),e=Ga.y.toFixed(4),t=Ga.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Kv(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Lr).join(`
`)}function qv(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Zv(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(e,s),a=r.name;let o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Lr(n){return n!==""}function nh(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ih(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Jv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Yl(n){return n.replace(Jv,$v)}const Qv=new Map;function $v(n,e){let t=Ne[e];if(t===void 0){const i=Qv.get(e);if(i!==void 0)t=Ne[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Yl(t)}const ex=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sh(n){return n.replace(ex,tx)}function tx(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function rh(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function nx(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Df?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===Pf?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===qn&&(e="SHADOWMAP_TYPE_VSM"),e}function ix(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Js:case Qs:e="ENVMAP_TYPE_CUBE";break;case jo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function sx(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Qs:e="ENVMAP_MODE_REFRACTION";break}return e}function rx(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Cf:e="ENVMAP_BLENDING_MULTIPLY";break;case $m:e="ENVMAP_BLENDING_MIX";break;case eg:e="ENVMAP_BLENDING_ADD";break}return e}function ax(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function ox(n,e,t,i){const s=n.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=nx(t),l=ix(t),u=sx(t),d=rx(t),h=ax(t),f=Kv(t),g=qv(r),_=s.createProgram();let m,p,v=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const x=v+m+a,E=v+p+o,R=eh(s,s.VERTEX_SHADER,x),T=eh(s,s.FRAGMENT_SHADER,E);s.attachShader(_,R),s.attachShader(_,T),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function D(C){if(n.debug.checkShaderErrors){const k=s.getProgramInfoLog(_).trim(),O=s.getShaderInfoLog(R).trim(),Y=s.getShaderInfoLog(T).trim();let W=!0,V=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(W=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,_,R,T);else{const j=th(s,R,"vertex"),G=th(s,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}ir.BlurDirectionX=new ae(1,0);ir.BlurDirectionY=new ae(0,1);const EM={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    `});_.toneMapped=!1;const m=new pt(g,_);m.name="zodiacal-light",m.renderOrder=-8,t.add(m),i.push(g,_);const p=new w;return{group:t,update(v){v.getWorldPosition(p),_.uniforms.uCamPos.value.copy(p)},dispose:()=>{for(const v of i)v.dispose()}}}const zM=`
...
`,kM={earth:{tint:[.35,.6,1],power:3,intensity:1},venus:{tint:[1,.82,.55],power:2.6,intensity:.95},mars:{tint:[1,.55,.35],power:4,intensity:.4},jupiter:{tint:[.95,.8,.6],power:3.2,intensity:.55},saturn:{tint:[1,.9,.65],power:3.2,intensity:.5},uranus:{tint:[.6,.85,.95],power:3.2,intensity:.6},neptune:{tint:[.35,.5,.95],power:3.2,intensity:.6}};function GM(n){return kM[n]??null}function VM(n,e,t){const i=t?.power??3.2,s=t?.intensity??.9,r=t?.base??.08,a=new as(n*1.06,48,32),o=new lt({vertexShader:zM,fragmentShader:BM,uniforms:{uColor:{value:new Le(...e)},uBase:{value:r},uPower:{value:i},uIntensity:{value:s}},transparent:!0,blending:Di,side:ri,depthWrite:!1});o.toneMapped=!1;const c=new pt(a,o);return c.renderOrder=2,c.frustumCulled=!1,c.name="atmosphere",c.disposeAtmosphere=()=>{a.dispose(),o.dispose()},c}function WM(n,e){const i=1-Math.abs(n-.42)*1.4,s=1-Math.abs(n-.86)*2.2;let r=Math.max(i,s*.8);r*=1-Math.exp(-Math.pow((n-.72)/.012,2))*.9,r*=1-Math.exp(-Math.pow((n-.95)/.008,2))*.5;const a=Math.min(n,1-n);return r*=Kr.clamp(a/.03,0,1),Kr.clamp(r,0,1)}function XM(n){const i=document.createElement("canvas");i.width=1024,i.height=1;const s=i.getContext("2d"),r=s.createImageData(1024,1),[a,o,c]=n;for(let u=0;u<1024;u++){const d=u/1023,h=WM(d),f=h;r.data[u*4+0]=a*(.7+.3*f),r.data[u*4+1]=o*(.7+.3*f),r.data[u*4+2]=c*(.7+.3*f),r.data[u*4+3]=h*255}s.putImageData(r,0,0);const l=new Jo(i);return l.colorSpace=Mt,l.anisotropy=4,l.needsUpdate=!0,l}function YM(n){const e=n.attributes.position,t=n.attributes.uv;for(let a=0;a<e.count;a++){const o=e.getX(a),c=e.getY(a),l=Math.hypot(o,c);t.setXY(a,l,0)}let i=1/0,s=-1/0;for(let a=0;a<e.count;a++){const o=Math.hypot(e.getX(a),e.getY(a));o<i&&(i=o),o>s&&(s=o)}const r=s-i||1;for(let a=0;a<e.count;a++){const o=Math.hypot(e.getX(a),e.getY(a));t.setXY(a,(o-i)/r,0)}t.needsUpdate=!0}const so=1,Zi=1495978707e-1,Gh=new Map;function jM(n,e){let t=Gh.get(n);return t||(t=XM(e),Gh.set(n,t)),t}const ts={bodyRadiusKm:Ap,dwarfRadiusKm:wp,moonRadiusKm:dM,planetDistance:Tp,moonDistance:(n,e)=>(e?fM(e,n):null)??Dp(n),followDistanceKm:pM,beltSizeFactor:1},Hn={bodyRadiusKm:n=>n/Zi*so,dwarfRadiusKm:n=>n/Zi*so,moonRadiusKm:n=>n/Zi*so,planetDistance:n=>n,moonDistance:n=>n/Zi*so,followDistanceKm:n=>Math.max(1.5,n/Zi*8),beltSizeFactor:0};function KM(n,e,t){const i=(s,r)=>s+(r-s)*t;return{bodyRadiusKm:s=>i(n.bodyRadiusKm(s),e.bodyRadiusKm(s)),dwarfRadiusKm:s=>i(n.dwarfRadiusKm(s),e.dwarfRadiusKm(s)),moonRadiusKm:s=>i(n.moonRadiusKm(s),e.moonRadiusKm(s)),planetDistance:s=>i(n.planetDistance(s),e.planetDistance(s)),moonDistance:(s,r)=>i(n.moonDistance(s,r),e.moonDistance(s,r)),followDistanceKm:(s,r)=>i(n.followDistanceKm(s,r),e.followDistanceKm(s,r)),beltSizeFactor:i(n.beltSizeFactor??1,e.beltSizeFactor??0)}}function Ho(n){return new w(-n.x,n.z,-n.y)}function Vh(n,e){return e.set(-n.x,n.z,-n.y),e}function qM(n,e){const t=C2(n,0,256),i=t.map(u=>{const d=Math.hypot(u.x,u.y,u.z);return Ho(u).multiplyScalar(e(d)/Math.max(1e-9,d))}),s=new ut().setFromPoints(i),r=new Zo({color:5599392,transparent:!0,opacity:.45}),a=new Cu(s,r),o=t.length,c=new Float32Array(o),l=new Float32Array(o*3);for(let u=0;u<o;u++){const d=t[u];c[u]=Math.hypot(d.x,d.y,d.z);const h=Ho(d).normalize();l[u*3]=h.x,l[u*3+1]=h.y,l[u*3+2]=h.z}return a.userData.radii=c,a.userData.unitDirs=l,a.userData.geo=s,a.userData.mat=r,a}function ZM(n,e,t){const i=new zx({canvas:n,antialias:!0,preserveDrawingBuffer:!0});i.setPixelRatio(Math.min(window.devicePixelRatio,2)),i.setSize(window.innerWidth,window.innerHeight),i.outputColorSpace=Mt,i.shadowMap.enabled=!0,i.shadowMap.type=Pf;const s=new Bx;s.background=new Le(5);const r=new rn(50,window.innerWidth/window.innerHeight,5e-4,2e4);r.position.set(0,16,30);const a=new f2(r,i.domElement);a.enableDamping=!0,a.dampingFactor=.08,a.enablePan=!1;const o=new Jx(16773848,3.5,0,0);lM(o,ji.far),s.add(o),s.add(new Qx(2240580,.4));const c=FM(new Hu,"textures/milkyway_equirect.png");c.group.traverse(v=>{v instanceof Zr&&v.material instanceof lt&&(v.material.uniforms.uPixelRatio.value=i.getPixelRatio())}),s.add(c.group);const l=MS();s.add(l);const u=yS();s.add(u);const d=AM(i,s,r,window.innerWidth,window.innerHeight),h=DM(Zc*4.5);s.add(h.sprite);const f=[c,d,h],g=new Map,_=[...e.filter(v=>v.kind!=="moon"),...e.filter(v=>v.kind==="moon")];for(const v of _){const x=v.kind==="star",E=v.kind==="moon",R=v.kind==="dwarf",T=x?t===Hn?v.radiusKm/Zi*1.15:Zc:E?t.moonRadiusKm(v.radiusKm):R?t.dwarfRadiusKm(v.radiusKm):t.bodyRadiusKm(v.radiusKm),D=x?v.radiusKm/Zi*1.15:E?Hn.moonRadiusKm(v.radiusKm):R?Hn.dwarfRadiusKm(v.radiusKm):Hn.bodyRadiusKm(v.radiusKm),H=x?Zc:E?ts.moonRadiusKm(v.radiusKm):R?ts.dwarfRadiusKm(v.radiusKm):ts.bodyRadiusKm(v.radiusKm),b=new as(T,48,32),S=F2(v),C=x?new rs({map:S}):new Jr({map:S,roughness:.92,metalness:0});f.push(b,C,S);const k=new pt(b,C);k.name=v.name,k.userData.id=v.id,uM(k,x);const O=new yi;O.name=`pivot:${v.name}`,O.rotation.z=Kr.degToRad(v.tiltDeg??0),O.add(k),s.add(O);const Y=new Lo(1.03,1.08,64),W=new rs({color:8378623,side:fn,transparent:!0,opacity:0,depthWrite:!1}),V=new pt(Y,W);V.rotation.x=-Math.PI/2,V.scale.setScalar(Math.max(.001,T)),V.visible=!1,O.add(V),f.push(Y,W);let j=null;if(v.rings){const Ee=T*v.rings.inner,Te=T*v.rings.outer,Ie=new Lo(Ee,Te,96,16);YM(Ie);const st=jM(v.id,v.rings.color),P=new Jr({map:st,color:16777215,side:fn,transparent:!0,opacity:v.rings.opacity,roughness:.85,metalness:0,depthWrite:!1}),je=new pt(Ie,P);je.rotation.x=-Math.PI/2,je.castShadow=!0,je.receiveShadow=!0,je.renderOrder=1,O.add(je),j=je,f.push(Ie,P)}let G=null;const re=GM(v.id);re&&!x&&!E&&(G=VM(T,re.tint,{power:re.power,intensity:re.intensity}),O.add(G));const de=V2(v.name),xe=new Pu({map:de,depthTest:!1}),Fe=new hp(xe),Ye=x?3.4:Math.max(1.3,T*2.4);Fe.scale.set(Ye,Ye*.25,1),Fe.position.y=T+Ye*.35,O.add(Fe),f.push(de,xe);let X=null;if(v.elements){const Ee=Te=>E?t.moonDistance(Te,v.id):t.planetDistance(Te);if(v.id==="moon"){const Ie=[],st=new Float32Array(129),P=new Float32Array(129*3);for(let ke=0;ke<=128;ke++){const Me=da(0+ke/128*27.55455),ot=Math.hypot(Me[0],Me[1],Me[2]),Ae=ot*oi,Ce=Ho({x:Me[0],y:Me[1],z:Me[2]});Ie.push(Ce.clone().multiplyScalar(t.moonDistance(Ae,"moon")/Math.max(1e-9,ot))),st[ke]=Ae;const A=Ce.normalize();P[ke*3]=A.x,P[ke*3+1]=A.y,P[ke*3+2]=A.z}const je=new ut().setFromPoints(Ie),We=new Zo({color:5599392,transparent:!0,opacity:.45});X=new Cu(je,We),X.userData.geo=je,X.userData.mat=We,X.userData.radii=st,X.userData.unitDirs=P,f.push(je,We)}else X=qM(v.elements,Ee),E||s.add(X)}const $=E&&v.parent?g.get(v.parent)??null:null,ge=v.rings?2*T*v.rings.outer:2*T,he={def:v,pivot:O,mesh:k,label:Fe,orbit:X,orbitEmphasis:V,ringsMesh:j,atmosphereMesh:G,parent:$,spin:0,worldPos:new w,sceneRadius:T,visibleRadius:H,trueRadius:D,builtRadius:T,cloudsMesh:null,frameExtent:ge};g.set(v.id,he)}for(const v of g.values())v.orbit&&v.parent&&(v.orbit.removeFromParent(),v.parent.pivot.add(v.orbit));const m=[];for(const v of W2){const x=sM(v);m.push(x),s.add(x.mesh),s.add(x.points)}Hp({belts:m},0,t,0);function p(){for(const v of f)v.dispose();for(const v of m)v.dispose();for(const v of g.values())v.cloudsMesh&&(v.cloudsMesh.geometry.dispose(),v.cloudsMesh.material.dispose()),v.atmosphereMesh&&v.atmosphereMesh.disposeAtmosphere();l.userData.dispose?.();for(const v of u.children){const x=v;x.geometry.dispose(),x.material.dispose()}a.dispose(),i.dispose()}return{renderer:i,camera:r,controls:a,scene:s,bodies:g,belts:m,sunLight:o,skybox:c,constellations:l,constellationFigures:u,post:d,sunGlow:h.sprite,userData:{},dispose:p}}const vt=4800;function Fu(n){let e=0,t=0,i=0;for(const r of n.stars){const[a,o,c]=Qo(r.raHours,r.decDeg);e+=a,t+=o,i+=c}const s=Math.hypot(e,t,i)||1;return[e/s,t/s,i/s]}function Gr(n,e){return n[0]*e[0]+n[1]*e[1]+n[2]*e[2]}function Uo(n,e){return[n[1]*e[2]-n[2]*e[1],n[2]*e[0]-n[0]*e[2],n[0]*e[1]-n[1]*e[0]]}function vo(n){const e=Math.hypot(n[0],n[1],n[2])||1;return[n[0]/e,n[1]/e,n[2]/e]}function tc(n){const e=Fu(n),t=n.stars.map(m=>Qo(m.raHours,m.decDeg)),i=Math.abs(e[1])<.9?[0,1,0]:[1,0,0],s=vo(Uo(e,i)),r=Uo(e,s);let a=0,o=0,c=0;for(const m of t){const p=Gr(m,s),v=Gr(m,r);a+=p*p,c+=p*v,o+=v*v}const l=.5*Math.atan2(2*c,a-o),u=Math.cos(l),d=Math.sin(l);let h=[s[0]*u+r[0]*d,s[1]*u+r[1]*d,s[2]*u+r[2]*d],f=0,g=0;for(const m of t){const p=Gr(m,h);p>f&&(f=p),-p>g&&(g=-p)}return g>f&&(h=[-h[0],-h[1],-h[2]]),{halfExtent:Math.max(f,g),axis:h,labelDir:m=>{const p=Math.cos(m),v=Math.sin(m);return[e[0]*p+h[0]*v,e[1]*p+h[1]*v,e[2]*p+h[2]*v]}}}const Wh=22,$c=48;function JM(n,e){const t=n[0]*e[0]+n[1]*e[1]+n[2]*e[2],i=Math.PI/180,s=Math.acos(Math.min(1,Math.max(-1,t)))/i;return s<=Wh?1:s>=$c?0:($c-s)/($c-Wh)}const ks=.28,Xh=1,QM=.5,Yh=.05,$M=1,eS=.75;function zu(n){return Yh+($M-Yh)*Math.pow(n,eS)}const Vr=9416959,Ql=8191066,tS=0,$l=.45,nS=.7,iS=8,sS=11,rS=.15,aS=2.5;function Ir(n){const e=2*Math.PI*(n/aS);return 1-rS*(1-Math.sin(e))/2}const oS=.02,cS=.35,lS=.016,uS=.011,dS=.018;function Bu(n){return tc(n).halfExtent<=dS?uS:lS}function hS(n){const e=Bu(n),t=$o(n.name).fontSize;return e*(hn/t)}function ku(n){return $o(n.name).inkWidthPx/hn*hS(n)}function fS(n){const e=tc(n);return Math.min(e.halfExtent,cS)+oS+ku(n)/2}const jh=.006;function pS(n,e){const t=vo(e),i=ku(n)/2,s=Bu(n)/2,r=Math.abs(t[1])<.9?[0,1,0]:[1,0,0],a=vo(Uo(t,r)),o=vo(Uo(t,a)),c=n.stars.map(u=>Qo(u.raHours,u.decDeg)),l=u=>Math.abs(Gr(u,a))<i+jh&&Math.abs(Gr(u,o))<s+jh;for(const[u,d]of n.lines)for(let h=0;h<=1.0001;h+=.05){const f=[c[u][0]+(c[d][0]-c[u][0])*h,c[u][1]+(c[d][1]-c[u][1])*h,c[u][2]+(c[d][2]-c[u][2])*h];if(l(f))return!0}for(const u of c)if(l(u))return!0;return!1}const mS=[1,1.5],gS=[1,-1],Kh=.004,_S=.25,vS=10;function Cp(n){const e=n.map((s,r)=>{const a=tc(s),o=Fu(s);return{i:r,pose:a,dir:o,margin0:fS(s),inkHalf:ku(s)/2,halfH:Bu(s)/2+Kh/2}}),t=e.map(s=>s.i).sort((s,r)=>{const a=e[r].pose.halfExtent-e[s].pose.halfExtent;return a!==0?a:n[s].name.localeCompare(n[r].name)}),i=new Array(n.length).fill(null);for(const s of t){const r=e[s];let a=null;for(const c of gS)for(const l of mS){const u=r.margin0*l,d=Math.cos(u),h=c*Math.sin(u),f=[r.dir[0]*d+r.pose.axis[0]*h,r.dir[1]*d+r.pose.axis[1]*h,r.dir[2]*d+r.pose.axis[2]*h];let g=_S*(l-1);pS(n[s],f)&&(g+=vS);for(const _ of t){const m=i[_];m&&(g+=xS(r,f,m))}(!a||g<a.score)&&(a={score:g,side:c,marginScale:l,dir:f,offset:u})}const o=a;i[s]={side:o.side,marginScale:o.marginScale,dir:o.dir,inkHalf:r.inkHalf+Kh/2,halfH:r.halfH,offset:o.offset}}return i}function xS(n,e,t){const i=n.inkHalf+t.inkHalf,s=n.halfH+t.halfH;let r=e[0]+t.dir[0],a=e[1]+t.dir[1],o=e[2]+t.dir[2];const c=Math.hypot(r,a,o);if(c<1e-6)return 0;r/=c,a/=c,o/=c;let l=a*e[2]-o*e[1],u=o*e[0]-r*e[2],d=r*e[1]-a*e[0];const h=Math.hypot(l,u,d);if(h<1e-6)return 0;l/=h,u/=h,d/=h;const f=a*d-o*u,g=o*l-r*d,_=r*u-a*l,m=l*e[0]+u*e[1]+d*e[2],p=f*e[0]+g*e[1]+_*e[2],v=l*t.dir[0]+u*t.dir[1]+d*t.dir[2],x=f*t.dir[0]+g*t.dir[1]+_*t.dir[2],E=(m-v)/i,R=(p-x)/s,T=E*E+R*R;return T<1?1-T:0}const el=2,qh=2756,tl=.5;function Rp(n){if(n<=el)return tl;if(n>=qh)return 1;const e=(n-el)/(qh-el);return tl+(1-tl)*e*e*(3-2*e)}function MS(){const n=new yi;n.name="constellations";const e=new Ro({color:13623551,size:3.2,sizeAttenuation:!1,transparent:!0,opacity:.9,depthWrite:!1}),t=Cp(kt),i=[],s=[],r=[],a=[],o=[],c=[],l=[],u=[];for(let f=0;f<kt.length;f++){i.push(t[f].dir);const g=kt[f],_=g.stars.map(W=>{const[V,j,G]=Qo(W.raHours,W.decDeg);return[V*vt,j*vt,G*vt]}),m=[];for(const[W,V]of g.lines)m.push(..._[W],..._[V]);const p=new ut;p.setAttribute("position",new at(m,3));const v=new Zo({color:Vr,transparent:!0,opacity:ks,depthWrite:!1});v.userData.baseColor=Vr;const x=new xh(p,v);x.name=`constellation-lines-core:${g.name}`,x.renderOrder=3,n.add(x);const E=new Jl;E.setPositions(m);const R=new Zl({color:Vr,transparent:!0,opacity:ks,depthWrite:!1,linewidth:iS,worldUnits:!0});R.resolution.set(1,1);const T=new qc(E,R);T.name=`constellation-lines:${g.name}`,T.renderOrder=2,T.computeLineDistances(),n.add(T),o.push(E),c.push(R);const D=new Jl;D.setPositions(m);const H=new Zl({color:tS,transparent:!0,opacity:$l,depthWrite:!1,linewidth:sS,worldUnits:!0});H.resolution.set(1,1);const b=new qc(D,H);b.name=`constellation-lines-halo:${g.name}`,b.renderOrder=1,b.computeLineDistances(),n.add(b),l.push(D),u.push(H);const S=(vt+4)/vt,C=[];for(const W of _)C.push(W[0]*S,W[1]*S,W[2]*S);const k=new ut;k.setAttribute("position",new at(C,3));const O=new Ro({color:Ql,size:5.2,sizeAttenuation:!1,transparent:!0,opacity:0,depthWrite:!1}),Y=new Zr(k,O);Y.name=`constellation-stars-emph:${g.name}`,Y.visible=!1,Y.renderOrder=4,n.add(Y),r.push(k),a.push(O);for(const W of _)s.push(...W)}const d=new ut;d.setAttribute("position",new at(s,3));const h=new Zr(d,e);return h.name="constellation-stars",h.renderOrder=4,n.add(h),n.userData.labelDirs=i,n.userData.dispose=()=>{for(const f of n.children){const g=f;(g instanceof xh||g instanceof qc)&&(g.geometry.dispose(),g.material.dispose())}for(const f of r)f.dispose();for(const f of a)f.dispose();for(const f of o)f.dispose();for(const f of c)f.dispose();for(const f of l)f.dispose();for(const f of u)f.dispose();d.dispose(),e.dispose()},n}const Wr=new Map(kt.map((n,e)=>[n.name,e])),Zh=new Map;function SS(n){return`constellation-figures/${n.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/\s+/g,"_")}.png`}function yS(){const n=new yi;n.name="constellation-figures",n.visible=!1;const e=new Hu;for(const t of aM){if(!Wr.has(t.constellation))continue;let i=Zh.get(t.constellation);i||(i=e.load(SS(t.constellation)),Zh.set(t.constellation,i)),i.colorSpace=Mt,i.anisotropy=4;const s=oM(t),r=new rs({map:i,transparent:!0,opacity:0,depthWrite:!1,side:fn}),a=new pt(new la(1,1),r),o=vt*.998;a.position.set(s.position[0]*o,s.position[1]*o,s.position[2]*o),a.up.set(s.upHint[0],s.upHint[1],s.upHint[2]),a.lookAt(0,0,0),a.rotateZ(s.rotationRad),a.scale.set(s.planeSize[0]*vt,s.planeSize[1]*vt,1),a.name=`constellation-figure:${t.constellation}`,n.add(a)}return n}function ES(n,e,t){for(const i of n.children){const s=i.name??"";if(!s.startsWith("constellation-figure:"))continue;const r=Wr.get(s.slice(21));if(r===void 0)continue;const a=e[r]??0,o=Math.min(QM,zu(a))*t;i.visible=o>.005,i.material.opacity=o}}function bS(n,e,t=1,i,s=0){for(const r of n.children){const a=r.name??"";if(a==="constellation-stars"){r.material.opacity=t;continue}if(a.startsWith("constellation-stars-emph:")){if(Wr.get(a.slice(25))===void 0)continue;const _=i!=null&&i!==""&&a===`constellation-stars-emph:${i}`,m=r.material;_?m.opacity=Ir(s):m.opacity=0,r.visible=m.opacity>.005;continue}const o=a.startsWith("constellation-lines-halo:")?a.slice(25):null;if(o!==null){const g=Wr.get(o);if(g===void 0)continue;const _=e[g]??0,m=i!=null&&i!==""&&o===i,p=r.material;m?p.opacity=Ir(s):p.opacity=($l+(nS-$l)*_)*t;continue}const c=a.startsWith("constellation-lines-core:")?a.slice(25):null,l=c===null&&a.startsWith("constellation-lines:")?a.slice(20):null,u=c??l;if(u===null)continue;const d=Wr.get(u);if(d===void 0)continue;const h=e[d]??0,f=i!=null&&i!==""&&u===i;if(c!==null){const g=r.material;f?(g.color.setHex(Ql),g.opacity=Ir(s)):(g.color.setHex(Vr),g.opacity=(ks+(Xh-ks)*h)*t);continue}{const g=r.material;f?(g.color.setHex(Ql),g.opacity=Ir(s)):(g.color.setHex(Vr),g.opacity=(ks+(Xh-ks)*h)*t)}}}function Lp(n,e,t){let i=n.userData.updateOrder;i||(i=[...n.bodies.values()].sort((a,o)=>{const c=a.parent?1:0,l=o.parent?1:0;return c-l}),n.userData.updateOrder=i);const s=TS,r=AS;for(const a of i){const{def:o,pivot:c}=a;if(o.kind==="star")c.position.set(0,0,0),a.worldPos.set(0,0,0);else if((o.kind==="planet"||o.kind==="dwarf")&&o.elements){const l=Io(o.elements,e,r),u=Vh(l,s),d=Math.hypot(l.x,l.y,l.z),h=t.planetDistance(d)/Math.max(1e-9,d);c.position.copy(u.multiplyScalar(h)),a.worldPos.copy(c.position)}else if(o.kind==="moon"&&o.elements){let l;if(o.id==="moon"){const m=da(e);l={x:m[0],y:m[1],z:m[2]}}else l=Io(o.elements,e,r);const u=Vh(l,s),d=Math.hypot(l.x,l.y,l.z),h=o.id==="moon"?d*oi:d,f=t.moonDistance(h,o.id)/Math.max(1e-9,d),g=u.multiplyScalar(f),_=a.parent;_?(g.applyQuaternion(_.pivot.quaternion),c.position.copy(_.worldPos).add(g)):c.position.copy(g),a.worldPos.copy(c.position)}}}const TS=new w,AS={x:0,y:0,z:0},Jh=new Map;function Ip(n){let e=Jh.get(n.def.id);if(e===void 0){const t=(n.def.a[0]+n.def.a[1])/2;e=Tp(t),Jh.set(n.def.id,e)}return e}function Hp(n,e,t,i){for(const s of n.belts)rM(s,e,t,t.beltSizeFactor),bp(s,i,Ip(s),t.beltSizeFactor??1)}function wS(n,e,t){for(const i of n.belts)bp(i,t,Ip(i),e.beltSizeFactor??1)}function DS(n,e){for(const i of n.bodies.values()){const s=i.visibleRadius+(i.trueRadius-i.visibleRadius)*e,r=Math.max(1e-7,s/i.builtRadius);i.mesh.scale.setScalar(r),i.ringsMesh&&i.ringsMesh.scale.setScalar(r),i.atmosphereMesh&&i.atmosphereMesh.scale.setScalar(r),i.orbitEmphasis.scale.setScalar(Math.max(.001,s));const a=i.def.kind==="star"?3.4:Math.max(1.3,s*2.4);i.label.scale.set(a,a*.25,1),i.label.position.y=s+a*.35,i.label.material.opacity=1,i.sceneRadius=s}const t=n.bodies.get("sun");t&&n.sunGlow.scale.set(t.sceneRadius*4.5,t.sceneRadius*4.5,1)}function PS(n,e,t){const i=n.userData.radii,s=n.userData.unitDirs,r=n.userData.geo;if(!i||!s||!r)return;const a=r.getAttribute("position"),o=i.length;for(let c=0;c<o;c++){const l=i[c],u=t?e.moonDistance(l,t):e.planetDistance(l);a.setXYZ(c,s[c*3]*u,s[c*3+1]*u,s[c*3+2]*u)}a.needsUpdate=!0,r.computeBoundingSphere()}function Up(n,e,t){const i=n.userData.radii,s=n.userData.unitDirs,r=n.userData.geo;if(!i||!s||!r)return;const a=r.getAttribute("position"),o=27.55455;for(let c=0;c<=128;c++){const l=da(e+c/128*o),d=Math.hypot(l[0],l[1],l[2])*oi,f=Ho({x:l[0],y:l[1],z:l[2]}).normalize();i[c]=d,s[c*3]=f.x,s[c*3+1]=f.y,s[c*3+2]=f.z;const g=t.moonDistance(d,"moon");a.setXYZ(c,f.x*g,f.y*g,f.z*g)}a.needsUpdate=!0,r.computeBoundingSphere()}function CS(n,e){for(const t of n.bodies.values()){if(!t.def.rotationHours)continue;const i=t.def.rotationHours/24;t.spin+=e/Math.abs(i)*Math.PI*2*Math.sign(i),t.mesh.rotation.y=t.spin,t.cloudsMesh&&(t.cloudsMesh.rotation.y=t.spin*.05)}}function RS(n,e){const t=n.elements?n.elements.a:0;return e.moonDistance(t,n.id)}function Np(n,e){let t=0;for(const i of Nu)i.parent===n&&(t=Math.max(t,RS(i,e)));return t}function LS(n,e,t,i){const s=e!==""&&n===e,r=.5+.5*Math.sin(i*3.4);return{ringVisible:s,ringOpacity:s?.35+.55*r:0,ringBreath:1+.12*r,orbitOpacity:t?s?.95:.45:null,orbitColor:t?s?8378623:5599392:null}}function IS(n,e,t){for(const i of n.bodies.values()){const s=LS(i.def.id,e,i.orbit!==null,t);if(i.orbitEmphasis.visible=s.ringVisible,s.ringVisible){const r=i.orbitEmphasis.material;r.opacity=s.ringOpacity,i.orbitEmphasis.scale.setScalar(i.sceneRadius*s.ringBreath)}if(i.orbit&&s.orbitOpacity!==null&&s.orbitColor!==null){const r=i.orbit.material;r.opacity=s.orbitOpacity,r.color.set(s.orbitColor)}}}const HS=30,eu=.02,US=260,NS=8,Wi=new w;function OS(n,e,t,i){if(Wi.set(n[0]*vt,n[1]*vt,n[2]*vt),Wi.applyMatrix4(e.matrixWorldInverse),Wi.z>=-e.near)return{x:0,y:0,ok:!1};const s=Wi.x/-Wi.z,r=Wi.y/-Wi.z,a=(s*.5+.5)*t,o=(-r*.5+.5)*i;return!Number.isFinite(a)||!Number.isFinite(o)?{x:0,y:0,ok:!1}:{x:a,y:o,ok:!0}}const tu=new Map;function FS(n,e="base"){const t=`${e}:${n}`;let i=tu.get(t);return i||(i=document.createElement("canvas"),i.width=hn,i.height=yp,G2(i.getContext("2d"),n,e),tu.set(t,i)),i}function zS(n){const e=document.createElement("canvas");e.id="cst-labels",e.style.cssText="position:absolute; inset:0; width:100%; height:100%; pointer-events:none; z-index:5;";const t=n.parentElement;return t&&(t.style.position=t.style.position||"relative"),n.insertAdjacentElement("afterend",e),{canvas:e,setVisible:i=>{e.style.display=i?"block":"none"},dispose:()=>{e.remove(),tu.clear()}}}const BS=4;function kS(n,e,t,i,s,r=NS){if(s<=eu)return[];const a=US,o=BS,c=hn/yp,l=[];for(const h of n){if(h.occluded||!h.emphasized&&h.emphasis<=0)continue;const f=zu(h.emphasis)*s;if(f<=eu)continue;const g=OS(h.dir,e,t,i);if(!g.ok||g.x<-a||g.x>t+a||g.y<-a||g.y>i+a)continue;const _=HS*(h.emphasized?1.12:1),m=c*_,p=$o(h.name).inkWidthPx/hn;l.push({name:h.name,emphasized:h.emphasized,emphasis:h.emphasis,rank:h.emphasized?1:0,x:g.x,y:g.y,inkW:m*p,h:_,w:m,opacity:Math.min(1,f)})}l.sort((h,f)=>f.rank-h.rank||f.emphasis-h.emphasis);const u=[],d=[];for(const h of l){if(u.length>=r)break;const f=h.x-h.inkW/2-o,g=h.x+h.inkW/2+o,_=h.y-h.h/2-o,m=h.y+h.h/2+o;let p=!1;for(const v of d)if(f<v.x2&&g>v.x1&&_<v.y2&&m>v.y1){p=!0;break}p||(d.push({x1:f,x2:g,y1:_,y2:m}),u.push({name:h.name,emphasized:h.emphasized,x:h.x,y:h.y,w:h.w,h:h.h,opacity:h.opacity}))}return u}function GS(n,e,t,i,s,r){const a=n.canvas,o=Math.min(window.devicePixelRatio,2),c=Math.max(1,Math.round(s*o)),l=Math.max(1,Math.round(r*o));a.width!==c&&(a.width=c),a.height!==l&&(a.height=l);const u=a.getContext("2d");if(u.setTransform(o,0,0,o,0,0),u.clearRect(0,0,s,r),i<=.01)return;const d=kS(t,e,s,r,i);for(const h of d){const f=FS(h.name,h.emphasized?"green":"base");u.globalAlpha=h.opacity,u.drawImage(f,h.x-h.w/2,h.y-h.h/2,h.w,h.h)}u.globalAlpha=1}function Gu(n){const e=Math.min(1,Math.max(0,n));return e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2}function Qh(n,e){return[n[0]-e[0],n[1]-e[1],n[2]-e[2]]}function VS(n,e){return[n[0]+e[0],n[1]+e[1],n[2]+e[2]]}const $h=.62,WS=38;function Op(n,e,t,i=1){const s=t*Math.PI/360,r=Math.atan(Math.tan(s)*i),a=Math.max(e/(2*$h*Math.tan(s)),e/(2*$h*Math.tan(r)),.35),o=WS*Math.PI/180,c=Math.sin(o),l=Math.cos(o);return{pos:[n[0],n[1]+a*c,n[2]+a*l],target:n}}function XS(n,e,t=.85){const i=e*Math.PI/360,s=n/(t*Math.tan(i)),r=.42;return{pos:[0,s*r,s*Math.sqrt(1-r*r)],target:[0,0,0]}}function YS(n,e,t){const i=t*Math.PI/360,s=e/(.08*Math.tan(i)),r=Math.min(s,n*.82),a=.35;return{pos:[0,r*a,r*Math.sqrt(1-a*a)],target:[0,0,0],fov:120}}function jS(n,e,t,i,s=1,r=.55,a=6,o=120){const l=Math.atan2(t*Math.sin(e),t*Math.cos(e)-i)/r,u=180/Math.PI,d=2*l*u,h=2*Math.atan(l/s)*u,f=Math.min(o,Math.max(a,Math.max(d,h)));return{pos:[n[0]*i,n[1]*i,n[2]*i],target:[n[0]*t,n[1]*t,n[2]*t],fov:f}}function KS(n,e,t){n.t+=e;const i=Gu(n.t/n.duration),s=(l,u)=>l+(u-l)*i,r=t??n.toTarget,a=[s(n.fromTarget[0],r[0]),s(n.fromTarget[1],r[1]),s(n.fromTarget[2],r[2])],o=[s(n.fromOffset[0],n.toOffset[0]),s(n.fromOffset[1],n.toOffset[1]),s(n.fromOffset[2],n.toOffset[2])],c=n.fromFov+(n.toFov-n.fromFov)*i;return{target:a,offset:o,pos:VS(a,o),fov:c,done:n.t>=n.duration}}function ha(n,e,t,i,s,r,a){return{fromTarget:e,fromOffset:Qh(n,e),toTarget:t.target,toOffset:Qh(t.pos,t.target),duration:i,t:0,followId:s,toFov:t.fov??a,fromFov:r}}const qS="textures/planets",ZS={day:"_day.jpg",normal:"_normal.jpg",roughness:"_roughness.jpg",clouds:"_clouds.png"};function JS(n,e="day"){return`${qS}/${n}${ZS[e]}`}const ef=new Map;function QS(n,e=fetch){let t=ef.get(n);return t||(t=e(n,{method:"HEAD"}).then(i=>i.ok).catch(()=>!1),ef.set(n,t)),t}const tf=new Map;async function ro(n,e,t,i=fetch){const s=`${n}:${e}`,r=tf.get(s);if(r)return r;const a=JS(n,e);if(!await QS(a,i))return null;const o=await new Promise((c,l)=>{t.load(a,c,void 0,l)}).catch(()=>null);return o?(o.colorSpace=e==="normal"||e==="roughness"?Cn:Mt,o.wrapS=$s,tf.set(s,o),o):null}async function $S(n,e,t=fetch){const i=await ro(n,"day",e,t);if(!i)return null;const[s,r,a]=await Promise.all([ro(n,"normal",e,t),ro(n,"roughness",e,t),ro(n,"clouds",e,t)]);return{day:i,normal:s,roughness:r,clouds:a}}function ey(n,e,t){const i=t*1.015,s=new as(i,48,32),r=new Jr({map:e,transparent:!0,opacity:.85,depthWrite:!1,roughness:1,metalness:0}),a=new pt(s,r);return a.name=`clouds:${n.def.name}`,a.castShadow=!1,a.receiveShadow=!1,n.pivot.add(a),{mesh:a,geo:s,mat:r}}async function ty(n,e,t=fetch){let i=0;for(const s of n){const r=s.def.id,a=await $S(r,e,t);if(!a)continue;const o=s.mesh.material;if(o.map=a.day,o instanceof Jr&&(a.normal&&(o.normalMap=a.normal,o.normalScale=new ae(.8,.8)),a.roughness&&(o.roughnessMap=a.roughness,o.roughness=1)),o.needsUpdate=!0,i+=1,a.clouds&&!s.cloudsMesh){const{mesh:c}=ey(s,a.clouds,s.builtRadius);s.cloudsMesh=c}}return i}const Vu=[{bodyId:"sun",duration:2,zoom:3},{bodyId:"sun",duration:1.6,zoom:1},{bodyId:"earth",duration:2.2,zoom:1}],Wu=Vu.reduce((n,e)=>n+e.duration,0),nl=.3,nf=1.4,sf=Wu-1.6,il=Wu-.6;function ny(n,e,t,i){return!(n||e==="0"||t||i)}const Fp="solar_intro_seen";function iy(n){return n<nl||n>il?0:n<nf?(n-nl)/(nf-nl):n<sf?1:(il-n)/(il-sf)}const Xu=[{id:"pause",key:"Space",keys:["Space"],label:"Play / pause",hint:"Toggle the clock",group:"time"},{id:"speed-up",key:"ArrowUp",keys:["↑"],label:"Speed up",hint:"Raise sim speed",group:"time"},{id:"speed-down",key:"ArrowDown",keys:["↓"],label:"Slow down",hint:"Lower sim speed",group:"time"},{id:"now",key:"n",keys:["N"],label:"Jump to now",hint:"Reset the clock to today",group:"time"},{id:"reverse",key:"r",keys:["R"],label:"Reverse time",hint:"Run the clock backwards",group:"time"},{id:"orbits",key:"o",keys:["O"],label:"Toggle orbits",hint:"Show / hide orbit lines",group:"view"},{id:"labels",key:"l",keys:["L"],label:"Toggle labels",hint:"Show / hide body labels",group:"view"},{id:"belts",key:"b",keys:["B"],label:"Toggle belts",hint:"Show / hide the asteroid belts",group:"view"},{id:"figures",key:"f",keys:["F"],label:"Toggle figures",hint:"Show / hide constellation figures",group:"view"},{id:"milkyway",key:"m",keys:["M"],label:"Toggle Milky Way",hint:"Show / hide the deep-sky background",group:"sky"},{id:"zodiacal",key:"z",keys:["Z"],label:"Toggle zodiacal light",hint:"Show / hide the sunlit dust glow",group:"sky"},{id:"atmospheres",key:"a",keys:["A"],label:"Toggle atmospheres",hint:"Show / hide the fresnel rims",group:"sky"},{id:"post",key:"p",keys:["P"],label:"Toggle bloom / HDR",hint:"Post-processing on / off (F2)",group:"sky"},{id:"scale",key:"t",keys:["T"],label:"True / visible scale",hint:"Swap the scale mode",group:"camera"},{id:"camera-preset",key:"c",keys:["C"],label:"Camera preset",hint:"Cycle top / side view",group:"camera"},{id:"release",key:"Escape",keys:["Esc"],label:"Release follow",hint:"Stop tracking the picked body",group:"camera"},{id:"screenshot",key:"s",keys:["S"],label:"Save screenshot",hint:"Download a PNG of the view",group:"system"}];function sy(n){return n.map(e=>({id:`jump-${e.id}`,keys:[],label:`Go to ${e.name}`,hint:"Fly the camera to this body",group:"jump"}))}function ry(n){return[...Xu.map(t=>({id:t.id,keys:t.keys,label:t.label,hint:t.hint,group:t.group})),...sy(n)]}function ay(n){const e=n.length===1?n.toLowerCase():n;for(const t of Xu)if((t.key.length===1?t.key.toLowerCase():t.key)===e)return t.id;return/^[1-9]$/.test(n)?`jump-digit-${n}`:n==="0"?"jump-digit-0":null}function oy(n,e,t){if(n==="0")return t;const i=parseInt(n,10)-1;return i<0||i>=e.length?null:e[i].id}function cy(n,e){const t=n.elements;if(!t)return null;const i=xp(t,e);if(i.n===0)return null;const s=Tt(t,e),r=n.kind==="moon"?1:oi;return{periodDays:360/Math.abs(i.n),distanceKm:Math.hypot(s.x,s.y,s.z)*r,perihelionKm:i.a*(1-i.e)*r,aphelionKm:i.a*(1+i.e)*r}}function ly(n){if(!Number.isFinite(n)||n<=0)return"—";if(n<2)return`${(n*24).toFixed(1)} h`;if(n<365)return`${n.toFixed(1)} d`;const e=n/365.25;return`${e>=100?e.toFixed(0):e>=10?e.toFixed(1):e.toFixed(2)} yr`}function Hr(n){return!Number.isFinite(n)||n<0?"—":n<1e6?`${Math.round(n).toLocaleString("en-US")} km`:n<1e8?`${(n/1e6).toFixed(1)} M km`:`${(n/1e9).toFixed(2)} B km`}const uy={sun:"The Sun holds 99.86% of the Solar System’s mass.",mercury:"A Mercury year is just 88 days, yet one of its days lasts 176 Earth days.",venus:"Venus spins backwards, so there the Sun rises in the west.",earth:"The only known world with liquid-water oceans on its surface.",mars:"Home to Olympus Mons, the tallest volcano in the Solar System.",jupiter:"The Great Red Spot is a storm wider than Earth, raging for centuries.",saturn:"Its rings are mostly water ice, yet the system is barely 1 km thick in places.",uranus:"Uranus rolls around the Sun on its side — tilted about 98°.",neptune:"Winds here reach ~2,100 km/h, the fastest in the Solar System.",moon:"The Moon drifts away from Earth by about 3.8 cm each year.",pluto:"Pluto’s bright heart is Sputnik Planitia, a nitrogen-ice plain."};function dy(n){if(!Number.isFinite(n)||n===0)return"—";const e=n<0,t=Math.abs(n),i=t<48?`${t.toFixed(1)} h`:`${(t/24).toFixed(1)} d`;return e?`${i} (retrograde)`:i}function hy(n){const e=[{label:"Radius",value:Hr(n.radiusKm)},{label:"Day length",value:dy(n.rotationHours)},{label:"Axial tilt",value:`${n.tiltDeg.toFixed(0)}°`}],t=uy[n.id];return t&&e.push({label:"Fun fact",value:t}),e}function fy(n){return n.paused&&!n.cameraMoving&&!n.scrubbing&&!n.flightActive&&!n.morphActive&&!n.skyTourActive&&!n.introActive}const zp=Number.isFinite;function rf(n){if(n==null||n==="")return;const e=Number(n);return zp(e)?e:void 0}function Xi(n){if(!(n==null||n===""))return n==="1"||n==="true"}function py(n){const t=new URL(n,"http://localhost").searchParams,i={},s=rf(t.get("t"));s!==void 0&&(i.timeMs=s);const r=rf(t.get("sp"));r!==void 0&&(i.speedLog=r);const a=t.get("f");a!=null&&(i.follow=a);const o=t.get("c");o!=null&&(i.constellation=o);const c=t.get("sc");c==="t"?i.scale="true":c==="v"&&(i.scale="visible");const l=Xi(t.get("o"));l!==void 0&&(i.orbits=l);const u=Xi(t.get("l"));u!==void 0&&(i.labels=u);const d=Xi(t.get("b"));d!==void 0&&(i.belts=d);const h=Xi(t.get("fig"));h!==void 0&&(i.figures=h);const f=Xi(t.get("p"));f!==void 0&&(i.paused=f);const g=Xi(t.get("rv"));g!==void 0&&(i.reversed=g);const _=Xi(t.get("ev"));_!==void 0&&(i.eventsOpen=_);const m=t.get("cam");if(m){const p=m.split(",").map(Number);p.length===6&&p.every(zp)&&(i.cam={pos:[p[0],p[1],p[2]],target:[p[3],p[4],p[5]]})}return i}function Bp(n,e){const t=new URL(n,"http://localhost"),i=t.searchParams,s=(o,c)=>{c===void 0?i.delete(o):i.set(o,c)};if(s("t",e.timeMs!==void 0?String(Math.round(e.timeMs)):void 0),s("sp",e.speedLog!==void 0?String(af(e.speedLog)):void 0),s("f",e.follow===void 0?void 0:e.follow),s("c",e.constellation===void 0?void 0:e.constellation),s("sc",e.scale===void 0?void 0:e.scale==="true"?"t":"v"),s("o",e.orbits===void 0?void 0:e.orbits?"1":"0"),s("l",e.labels===void 0?void 0:e.labels?"1":"0"),s("b",e.belts===void 0?void 0:e.belts?"1":"0"),s("fig",e.figures===void 0?void 0:e.figures?"1":"0"),s("p",e.paused===void 0?void 0:e.paused?"1":"0"),s("rv",e.reversed===void 0?void 0:e.reversed?"1":"0"),s("ev",e.eventsOpen===void 0?void 0:e.eventsOpen?"1":"0"),e.cam){const[o,c,l,u,d,h]=[...e.cam.pos,...e.cam.target].map(af);s("cam",`${o},${c},${l},${u},${d},${h}`)}else i.delete("cam");const r=i.toString();return`${t.origin.startsWith("http")&&n.includes("://")?`${t.origin}${t.pathname}`:t.pathname}${r?`?${r}`:""}${t.hash}`}function af(n){return Math.round(n*1e6)/1e6}const sl=Math.PI/180,Yu=180/Math.PI,sr=Xt.map(n=>n.id),nc=new Map(Xt.map(n=>[n.id,n])),an=nc.get("earth"),my=Nu.find(n=>n.id==="moon"),gy=["mercury","venus"],_y=["mars","jupiter","saturn","uranus","neptune"];function Ci(n){return Math.hypot(n.x,n.y,n.z)}function os(n,e){return{x:n.x-e.x,y:n.y-e.y,z:n.z-e.z}}function $r(n){return{x:-n.x,y:-n.y,z:-n.z}}function cs(n,e){const t=n.x*e.x+n.y*e.y+n.z*e.z,i=Ci(n),s=Ci(e);if(i===0||s===0)return 0;const r=Math.min(1,Math.max(-1,t/(i*s)));return Math.acos(r)*Yu}function ns(n,e){const t=n/e;return t>=1?90:t<=0?0:Math.asin(t)*Yu}function vy(n){return gn+Math.round(n*864e5)}function fa(n,e){return e||Math.min(2,Math.max(.25,n/2e4))}function ju(n,e,t){const i=[];for(let s=n;s<=e+1e-9;s+=t)i.push(s);return(i.length===0||i[i.length-1]<e)&&i.push(e),i}function pa(n,e,t,i,s=48){const r=(Math.sqrt(5)-1)/2,a=u=>i?-n(u):n(u);let o=e,c=t;for(let u=0;u<s;u++){const d=c-r*(c-o),h=o+r*(c-o);a(d)<a(h)?c=h:o=d}const l=(o+c)/2;return{t:l,value:n(l)}}function rr(n,e,t,i,s,r){return{type:n,tDays:e,dateMs:vy(e),title:t,detail:i,bodyId:s,bodyId2:r}}function Ku(n,e,t){const i=ju(n,e,t),s=Xt.map(r=>i.map(a=>Tt(r.elements,a)));return{times:i,pos:s}}function qu(n,e,t){return os(n.pos[e][t],n.pos[sr.indexOf("earth")][t])}function rl(n){const e=Tt(an.elements,n),t=$r(e),[i,s,r]=da(n),a={x:i,y:s,z:r},o=cs(t,a),c=Ci(e)*oi,l=Ci(a)*oi;return{sep:o,sunR:ns(Uu.radiusKm,c),moonR:ns(my.radiusKm,l),dSunKm:c,dMoonKm:l}}function xy(n,e,t){const i=fa(e-n,t?.coarseStepDays),s=ju(n,e,i),r=s.map(o=>rl(o).sep),a=[];for(let o=1;o<r.length-1;o++){const c=r[o],l=c<r[o-1]&&c<r[o+1],u=c>r[o-1]&&c>r[o+1];if(!l&&!u)continue;const d=s[o],{t:h}=pa(g=>rl(g).sep,d-2,d+2,u),f=rl(h);if(l){const g=ns(an.radiusKm,f.dMoonKm);if(f.sep<f.sunR+f.moonR+g){const _=f.sep<f.moonR-f.sunR?"Total solar eclipse":f.sep<f.sunR-f.moonR?"Annular solar eclipse":"Partial solar eclipse";a.push(rr("solar-eclipse",h,"Solar eclipse",`${_} · Sun–Moon sep ${f.sep.toFixed(2)}°`,"sun","moon"))}}else{const g=180-f.sep,[_,m,p]=da(h),v=Ci({x:_,y:m,z:p})*oi,x=ns(an.radiusKm,v)-f.sunR,E=ns(an.radiusKm,v)+f.sunR;if(g<f.moonR+E){const R=g<x-f.moonR?"Total lunar eclipse":g<x+f.moonR?"Partial lunar eclipse":"Penumbral lunar eclipse";a.push(rr("lunar-eclipse",h,"Lunar eclipse",`${R} · ${g.toFixed(2)}° from opposition`,"moon"))}}}return a}function My(n,e,t){const i=Ku(n,e,fa(e-n,t?.coarseStepDays)),s=sr.indexOf("earth"),r=[];for(const a of gy){const o=sr.indexOf(a),c=nc.get(a),l=i.times.map((u,d)=>{const h=qu(i,o,d),f=$r(i.pos[s][d]);return cs(h,f)});for(let u=1;u<l.length-1;u++){if(!(l[u]<l[u-1]&&l[u]<l[u+1])||l[u]>30)continue;const d=i.times[u],h=E=>{const R=os(Tt(c.elements,E),Tt(an.elements,E)),T=$r(Tt(an.elements,E));return cs(R,T)},{t:f,value:g}=pa(h,d-2,d+2,!1),_=Ci(Tt(an.elements,f))*oi,m=os(Tt(c.elements,f),Tt(an.elements,f)),p=Ci(m)*oi,v=ns(Uu.radiusKm,_),x=ns(c.radiusKm,p);if(g<v+x){const E=g<v-x?"Transit (planet fully on the Sun)":"Partial transit";r.push(rr("transit",f,`${c.name} transit`,`${E} · sep ${g.toFixed(2)}°`,a))}}}return r}function Sy(n,e,t){const i=t?.conjunctionDeg??1,s=Ku(n,e,fa(e-n,t?.coarseStepDays));sr.indexOf("earth");const r=s.times.length,a=[],o=Xt.map((c,l)=>{const u=new Array(r);for(let d=0;d<r;d++)u[d]=qu(s,l,d);return u});for(let c=0;c<Xt.length;c++)for(let l=c+1;l<Xt.length;l++){const u=d=>cs(o[c][d],o[l][d]);for(let d=1;d<r-1;d++){const h=u(d);if(!(h<u(d-1)&&h<u(d+1))||h>i*2.5)continue;const f=s.times[d],g=p=>{const v=os(Tt(Xt[c].elements,p),Tt(an.elements,p)),x=os(Tt(Xt[l].elements,p),Tt(an.elements,p));return cs(v,x)},{t:_,value:m}=pa(g,f-2,f+2,!1);if(m<i){const p=Xt[c].name,v=Xt[l].name;a.push(rr("conjunction",_,`${p}–${v} conjunction`,`sep ${m.toFixed(2)}°`,Xt[c].id,Xt[l].id))}}}return a}function yy(n,e,t){const i=t?.oppositionDeg??170,s=Ku(n,e,fa(e-n,t?.coarseStepDays)),r=sr.indexOf("earth"),a=[];for(const o of _y){const c=sr.indexOf(o),l=nc.get(o),u=s.times.map((d,h)=>cs(qu(s,c,h),$r(s.pos[r][h])));for(let d=1;d<u.length-1;d++){if(!(u[d]>u[d-1]&&u[d]>u[d+1])||u[d]<170)continue;const h=s.times[d],f=m=>cs(os(Tt(l.elements,m),Tt(an.elements,m)),$r(Tt(an.elements,m))),{t:g,value:_}=pa(f,h-3,h+3,!0);_>i&&a.push(rr("opposition",g,`${l.name} opposition`,`elongation ${_.toFixed(2)}° from the Sun`,o))}}return a}function Ey(){const n=40.588*sl,e=83.537*sl,t=23.4392911*sl,i=Math.cos(e)*Math.cos(n),s=Math.cos(e)*Math.sin(n),r=Math.sin(e),a=s*Math.cos(t)+r*Math.sin(t),o=-s*Math.sin(t)+r*Math.cos(t),c=Math.hypot(i,a,o);return{x:i/c,y:a/c,z:o/c}}const al=Ey();function of(n){const e=Tt(nc.get("saturn").elements,n),t=Tt(an.elements,n),i=os(t,e),s=Math.abs(i.x*al.x+i.y*al.y+i.z*al.z),r=Math.min(1,s/(Ci(i)||1));return 90-Math.acos(r)*Yu}function by(n,e,t){const i=t?.edgeOnDeg??2,s=fa(e-n,t?.coarseStepDays),r=ju(n,e,s),a=r.map(of),o=[];for(let l=1;l<a.length-1;l++){if(!(a[l]<a[l-1]&&a[l]<a[l+1])||a[l]>i*2.5)continue;const u=r[l],{t:d,value:h}=pa(of,u-45,u+45,!1);h<i&&o.push(rr("saturn-edge-on",d,"Saturn rings edge-on",`ring plane tilt ${h.toFixed(2)}° from Earth`,"saturn"))}o.sort((l,u)=>l.tDays-u.tDays);const c=[];for(const l of o){const u=c[c.length-1];if(u&&l.tDays-u.tDays<30){const d=h=>parseFloat(h.detail.match(/tilt ([\d.]+)/)?.[1]??"99");d(l)<d(u)&&(c[c.length-1]=l)}else c.push(l)}return c}function kp(n,e,t){const i=[...xy(n,e,t),...My(n,e,t),...Sy(n,e,t),...yy(n,e,{coarseStepDays:t?.coarseStepDays}),...by(n,e,t)];return i.sort((s,r)=>s.dateMs-r.dateMs),i}const Ty=1,Ay=.01,wy=-3,Dy=2.5;function Gp(n){const e=Date.UTC(n,0,1),t=Date.UTC(n+1,0,1);return{span0Days:(e-gn)/864e5,spanLenDays:(t-e)/864e5}}function Py(n,e,t,i){const s=n+i*Ty;return Math.max(e,Math.min(e+t-1e-6,s))}function Cy(n,e){const t=n-e*Ay;return Math.max(wy,Math.min(Dy,t))}const Ry={sun:"☀️",moon:"🌙",mercury:"⚪",venus:"💛",earth:"🌍",mars:"🔴",jupiter:"🟠",saturn:"🪐",uranus:"🔵",neptune:"🟣"},Ly={"solar-eclipse":"🌑","lunar-eclipse":"🌕","saturn-edge-on":"🪐"};function Iy(n){const e=Ly[n.type];if(e)return e;const t=i=>i&&Ry[i]||"●";return n.type==="transit"?t(n.bodyId):n.type==="conjunction"?t(n.bodyId)+t(n.bodyId2):n.type==="opposition"?t(n.bodyId):"✦"}const Hy=40;function ic(n,e,t,i,s=Hy){const r=e>0?e:1,a=l=>Math.max(0,Math.min(1,(l-n)/r)),o=t.filter(l=>l.tDays>=n-1e-6&&l.tDays<n+r+1e-6).map(l=>({frac:a(l.tDays),emoji:Iy(l),title:l.title})).sort((l,u)=>l.frac-u.frac),c=Math.max(0,o.length-s);return{markers:o.slice(0,s),overflow:c,caretFrac:a(i)}}const Vp=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];function Uy(n){const e=n,t=[];for(let i=0;i<12;i++){const s=(Date.UTC(2001,i,1)-Date.UTC(2001,0,1))/864e5;s>=e||t.push({abbr:Vp[i],day:s,frac:s/e})}return t}function cf(n,e){const t=new Date(Date.UTC(n,0,1+Math.floor(e)));return`${Vp[t.getUTCMonth()]} ${t.getUTCDate()}`}function Ny(n,e,t){let i=null,s=1/0;for(const r of n){const a=Math.abs(r.x-e);a<=t&&a<s&&(s=a,i=r)}return i}const Wt=56,Oy=4;function Fy(n){const e=Math.max(0,1-n/Wt);return 1+(Oy-1)*e*e}function ao(n,e){const t=Math.sqrt(n*n+e*e);if(t>=Wt)return null;const i=Fy(t);return{x:n*i,y:e*i,scale:i}}function lf(n,e){return Math.max(0,Math.min(e,n))}const zy=["January","February","March","April","May","June","July","August","September","October","November","December"];function By(n,e){return new Date(Date.UTC(n,e+1,0)).getUTCDate()}function ky(n,e){return new Date(Date.UTC(n,e,1)).getUTCDay()}function Gy(n,e){const t=By(n,e),i=ky(n,e),s=new Array(42).fill(0);for(let r=1;r<=t;r++)s[i+(r-1)]=r;return{grid:s,daysInMonth:t,firstWeekday:i}}function Vy(n,e){return`${zy[e]} ${n}`}function uf(n,e){return n.getUTCFullYear()===e.getUTCFullYear()&&n.getUTCMonth()===e.getUTCMonth()&&n.getUTCDate()===e.getUTCDate()}const Wy=.5,df=864e5,nu=new Map;function Wp(n){const e=Date.UTC(n,0,1),t=Date.UTC(n+1,0,1);return{span0Days:(e-gn)/df,spanLenDays:(t-e)/df}}function Xp(n){return nu.has(n)}function Yp(n){const e=nu.get(n);if(e)return e;const{span0Days:t,spanLenDays:i}=Wp(n),s=kp(t,t+i,{coarseStepDays:Wy}),r={year:n,span0Days:t,spanLenDays:i,events:s};return nu.set(n,r),r}"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("sw.js").catch(()=>{})});const Xy=.15;let Ai=null,No=!1;function ea(){Ai&&(Ai=null,N.controls.enabled=!0,N.controls.update())}function Yy(){const n=N.camera.position,e=n.length();if(e<1e-6)return;const t=Math.acos(Math.min(1,Math.max(-1,n.y/e)));Ai={theta:Math.atan2(n.x,n.z),phi:t,radius:e},N.controls.enabled=!1}function jy(n){if(!Ai)return;Ai.theta+=Xy*n;const{theta:e,phi:t,radius:i}=Ai,s=Math.sin(t);N.camera.position.set(i*s*Math.sin(e),i*Math.cos(t),i*s*Math.cos(e)),N.camera.lookAt(0,0,0)}for(const n of["pointerdown","wheel","keydown","touchstart"])window.addEventListener(n,ea,{passive:!0});const Oo=kt.map(n=>Fu(n)),Ky=kt.map(n=>tc(n).halfExtent),Fo=new Float32Array(kt.length),qy=200;let hf=0,ar="";const oo=new w;let Ri=null;const Zy=Cp(kt).map(n=>n.dir),ol=new pp,ff=new w;function Jy(){oo.set(0,0,-1).applyQuaternion(N.camera.quaternion);const n=oo.x,e=oo.y,t=oo.z;for(let i=0;i<Oo.length;i++){const s=Oo[i];Fo[i]=JM(s,[n,e,t])}}function Qy(n){if(n-hf<qy)return;const e=N.camera.position,t=`${e.x.toFixed(2)}|${e.y.toFixed(2)}|${e.z.toFixed(2)}|${N.camera.quaternion.w.toFixed(3)}|${jt}`;if(t===ar)return;hf=n,ar=t;const i=Rp(N.camera.position.length());bS(N.constellations,Fo,i,jt||null,n/1e3),pr&&ES(N.constellationFigures,Fo,i)}function $y(n){if(!jt)return;const e=N.constellations.children.find(t=>t.name===`constellation-lines:${jt}`);e&&(e.material.opacity=Ir(n/1e3))}const Nt=document.getElementById("app"),on=document.getElementById("date"),or=document.getElementById("speed"),eE=document.getElementById("speed-value"),zo=document.getElementById("pause"),js=document.getElementById("reverse"),tE=document.getElementById("now"),Li=document.getElementById("find"),ti=document.getElementById("find-list"),cr=document.getElementById("orbits"),On=document.getElementById("labels"),lr=document.getElementById("belts"),Ks=document.getElementById("figures");let pr=!1;const co=document.getElementById("share"),Ur=document.getElementById("screenshot"),Nr=document.getElementById("tooltip"),Cr=document.getElementById("info"),Bo=document.getElementById("gl-lost");let Ut=null;const qs=document.getElementById("intro"),lo=document.getElementById("intro-title"),Ei=document.getElementById("intro-skip"),ta=document.getElementById("palette"),$i=document.getElementById("palette-input"),Or=document.getElementById("palette-list");let ur=!1,ko="",Si=0,na=[],cl=!0,Go=!0,iu=!0,uo=0;const nE=document.getElementById("gl-reload"),Zu=document.getElementById("hud-mini"),mr=document.getElementById("hud-date"),Ju=document.getElementById("hud-speed"),is=document.getElementById("hud-timeline"),ma=document.getElementById("hud-timeline-track"),su=document.getElementById("hud-timeline-dynamic"),jp=document.getElementById("hud-timeline-fill"),Kp=document.getElementById("hud-timeline-caret"),ru=document.getElementById("hud-timeline-year"),Os=document.getElementById("hud-tl-tip"),au=document.getElementById("hud-tl-lens"),xo=document.getElementById("hud-tl-lens-canvas"),iE=document.getElementById("hud-tl-lens-date"),Vo=document.getElementById("date-cal"),sE=document.getElementById("date-cal-title"),rE=document.getElementById("date-cal-prev"),aE=document.getElementById("date-cal-next"),oE=document.getElementById("date-cal-grid"),cE=document.getElementById("date-cal-today"),lE=document.getElementById("date-cal-y-5"),uE=document.getElementById("date-cal-y-1"),dE=document.getElementById("date-cal-y+1"),hE=document.getElementById("date-cal-y+5");let Tn=0,Un=0,ls=!1,ou=-1,cu=window.innerWidth<560;const pf=document.getElementById("info-name"),mf=document.getElementById("info-period"),gf=document.getElementById("info-distance"),_f=document.getElementById("info-range"),ll=document.getElementById("info-facts"),vf=document.getElementById("info-label-1"),xf=document.getElementById("info-label-2"),Mf=document.getElementById("info-label-3"),lu=document.getElementById("events-toggle"),qp=document.getElementById("events-range"),bi=document.getElementById("events-row"),Zs=document.getElementById("events-list"),Xr=document.getElementById("date-pick"),dr=new Map(ua.map(n=>[n.id,n])),ia=new Map(ua.filter(n=>n.kind==="moon"&&n.parent).map(n=>[n.id,n.parent])),le=new i2(Date.now());let N,Qt=ts,ft="",ni=!0,Ii="",jt="",Sf=le.t,uu=performance.now(),sa=0,du=!0;function cn(){du=!0}const jn={x:0,y:0,z:0},Kn={x:0,y:0,z:0};let yf=!1,ul=!1,Qu=!1,Yt=null;const fE=3;let Ge=null;const hu=document.getElementById("scale-real"),Zp=document.getElementById("scale-visible"),dl=document.getElementById("scale-caption"),Ef=[[0,"Morphing to real scale…"],[.2,"Sizes snap to reality — the default view exaggerates radii ~300× (Sun) to ~40,000× (Earth)."],[.5,"Distances snap to reality — Earth is 150 million km from the Sun, not 15 units."],[.8,"At real scale Neptune is 4.5 BILLION km out. Most of this view is empty space."]];function pE(n){let e=Ef[0][1];for(const[t,i]of Ef)n>=t&&(e=i);return e}function Jp(){return Ge?Ge.dir===0?Ge.p>=.5?"real":"visible":Ge.dir===1?"real":"visible":Qt===Hn?"real":"visible"}function $u(){const n=Jp()==="real";for(const e of[hu,Zp]){if(!e)continue;const t=e===hu?n:!n;e.classList.toggle("active",t),e.setAttribute("aria-checked",String(t))}dl&&(dl.hidden=!Ge,Ge&&(dl.textContent=Ge.dir===-1?"Returning to the visible view…":Ge.dir===0?"Real scale — sizes and distances to the same ratio. Toggle back any time.":pE(Gu(Ge.p))))}function mE(){Ge&&(Ge.p>=1?(Ge={p:1,dir:0,reframed:!1},Qt=Hn):(Ge=null,Qt=ts),$u(),qe())}function fu(n){Jp()!==n&&(cn(),Ge&&Ge.dir!==0?(Ge.dir=n==="real"?1:-1,Ge.reframed=!1):n==="real"?(Yt=null,ea(),Ge={p:0,dir:1,reframed:!1}):(Yt=null,ea(),Ge={p:1,dir:-1,reframed:!1}),$u())}function Ni(){const n=N.bodies.get("moon");n?.orbit&&Up(n.orbit,le.t,Qt),sa=performance.now()}function gE(n){N&&N.dispose(),N=ZM(Nt,ua,n),N.controls.addEventListener("change",qe);for(const t of N.bodies.values())t.orbit&&t.parent&&t.parent.pivot.add(t.orbit);Qn(),Lp(N,le.t,Qt);const e=new Hu;if(ty(N.bodies.values(),e),ft){const t=N.bodies.get(ft);if(t){const i=Qt.followDistanceKm(t.def.radiusKm,t.def.kind==="dwarf");N.controls.target.copy(t.worldPos),N.camera.position.copy(t.worldPos).add(new w(i,i*.6,i))}}return N}const ci=50;function bf(n=!1){let e=0;for(const t of N.bodies.values()){const i=t.def.elements;if(i&&(t.def.kind==="planet"||!n&&t.def.kind==="dwarf")){const s=i.a*(1+i.e);e=Math.max(e,Qt.planetDistance(s))}}return Math.max(e,1)}function ra(n){return n==="constellations"?YS(vt,bf(),ci):XS(bf(!0),ci,.95)}function li(n){const e=N.bodies.get(n);if(!e)return null;const t=ia.get(n)??n,i=N.bodies.get(t)??e,s=Np(t,Qt),r=Math.max(i.frameExtent,s>0?2*s+i.sceneRadius:0);return Op([i.worldPos.x,i.worldPos.y,i.worldPos.z],r,ci,N.camera.aspect)}function _E(n){const e=kt.findIndex(t=>t.name===n);return e<0?null:jS(Oo[e],Ky[e],vt,vt/8,N.camera.aspect)}function ii(n,e=1.4,t=null,i=!1){ft=t??"",us(ft),Ii=t??"",jt="",ar="",qe(),ea(),No=i,oc();const s=t?ia.has(t)?ia.get(t):t:null;Yt=ha([N.camera.position.x,N.camera.position.y,N.camera.position.z],[N.controls.target.x,N.controls.target.y,N.controls.target.z],n,e,s,N.camera.fov,ci)}function vE(n){const e=_E(n);e&&(jt=n,ft="",Ii="",ea(),No=!1,ar="",oc(),Yt=ha([N.camera.position.x,N.camera.position.y,N.camera.position.z],[N.controls.target.x,N.controls.target.y,N.controls.target.z],e,1.6,null,N.camera.fov,ci),qe())}function xE(){const n=document.getElementById("anchors");n&&(n.addEventListener("click",e=>{const t=e.target.closest("button[data-fly]");if(!t)return;const i=t.dataset.fly;if(i==="system")ii(ra("system"),1.6,"sun");else if(i==="constellations")ii(ra("constellations"),1.8,"sun",!0);else{const s=li(i);s&&ii(s,1.4,i)}qe()}),hu?.addEventListener("click",()=>fu("real")),Zp?.addEventListener("click",()=>fu("visible")))}function Qn(){cn();for(const n of N.bodies.values())n.orbit&&(n.orbit.material.visible=cr.checked),n.label.visible=On.checked;Ri?.setVisible(On.checked);for(const n of N.belts)n.mesh.visible=lr.checked;N.constellationFigures.visible=pr}function ME(){const n=le.getSpeed(),e=le.isReversed?"← ":"",t=Math.abs(n);let i,s;return t>=100?(i=t.toFixed(0),s="d/s"):t>=1?(i=t.toFixed(1),s="d/s"):t>=.1?(i=t.toFixed(2),s="d/s"):(i=(t*24).toFixed(2),s="h/s"),`${e}${i} ${s}`}function sc(){const n=ME();eE.textContent=n,Ju.textContent=n}function ed(){const n=le.toDate(),e=n.getUTCFullYear(),t=String(n.getUTCMonth()+1).padStart(2,"0"),i=String(n.getUTCDate()).padStart(2,"0"),s=String(n.getUTCHours()).padStart(2,"0"),r=String(n.getUTCMinutes()).padStart(2,"0");on.textContent=`${e}-${t}-${i} ${s}:${r} UTC`,mr.textContent=cu?`${e}-${t}-${i}`:`${e}-${t}-${i} ${s}:${r}`;const a=String(e);if(ru.textContent!==a&&(ru.textContent=a),document.activeElement!==Xr){const o=`${e}-${t}-${i}`;Xr.value!==o&&(Xr.value=o)}}function SE(){const n=Xr.value;if(!n)return;const[e,t,i]=n.split("-").map(Number);if(!e||!t||!i)return;const s=le.toDate(),r=new Date(Date.UTC(e,t-1,i,s.getUTCHours(),s.getUTCMinutes()));Math.abs(r.getTime()-s.getTime())<6e4||(le.setDate(r),Ni(),cn(),on.classList.remove("flash"),on.offsetWidth,on.classList.add("flash"),cc()&&_r(),qe())}function gr(){sE.textContent=Vy(Tn,Un);const{grid:n}=Gy(Tn,Un),e=le.toDate(),t=new Date,i=document.createDocumentFragment();for(const s of n){const r=document.createElement("div");if(r.className="cal-day",s===0)r.classList.add("blank");else{r.textContent=String(s);const a=new Date(Date.UTC(Tn,Un,s));uf(a,e)&&r.classList.add("sel"),uf(a,t)&&Tn===t.getUTCFullYear()&&Un===t.getUTCMonth()&&r.classList.add("today"),r.addEventListener("click",()=>yE(s))}i.appendChild(r)}oE.replaceChildren(i)}function yE(n){const e=le.toDate(),t=new Date(Date.UTC(Tn,Un,n,e.getUTCHours(),e.getUTCMinutes()));Math.abs(t.getTime()-e.getTime())<6e4||(le.setDate(t),Ni(),cn(),on.classList.remove("flash"),on.offsetWidth,on.classList.add("flash"),cc()&&_r(),qe(),gr())}function Qp(){const n=le.toDate();Tn=n.getUTCFullYear(),Un=n.getUTCMonth(),ou=n.getUTCDate(),ls=!0,Vo.classList.add("open"),Vo.setAttribute("aria-hidden","false"),gr()}function rc(){ls&&(ls=!1,Vo.classList.remove("open"),Vo.setAttribute("aria-hidden","true"))}function $p(n){const e=Tn*12+Un+n;Tn=Math.floor(e/12),Un=(e%12+12)%12,gr()}function ac(n){Tn+=n,gr()}lE.addEventListener("click",()=>ac(-5));uE.addEventListener("click",()=>ac(-1));dE.addEventListener("click",()=>ac(1));hE.addEventListener("click",()=>ac(5));mr.addEventListener("click",()=>{ls?rc():Qp()});mr.addEventListener("keydown",n=>{(n.key==="Enter"||n.key===" ")&&(n.preventDefault(),ls?rc():Qp())});rE.addEventListener("click",()=>$p(-1));aE.addEventListener("click",()=>$p(1));cE.addEventListener("click",()=>{const n=new Date,e=le.toDate(),t=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate(),e.getUTCHours(),e.getUTCMinutes()));le.setDate(t),Ni(),on.classList.remove("flash"),on.offsetWidth,on.classList.add("flash"),cc()&&_r(),qe(),Tn=n.getUTCFullYear(),Un=n.getUTCMonth(),gr()});document.addEventListener("pointerdown",n=>{if(!ls)return;const e=n.target;e&&(e.closest("#date-cal")||e===mr)||rc()});document.addEventListener("keydown",n=>{n.key==="Escape"?rc():n.key==="F2"&&(n.preventDefault(),ni=!ni,N.sunGlow.visible=ni,cn())});function oc(){if(!ft){if(jt){const t=kt.findIndex(l=>l.name===jt),i=t>=0?kt[t]:void 0;if(!i){Cr.hidden=!0,Rr(null);return}const[s,r,a]=Oo[t],o=Math.asin(Math.min(1,Math.max(-1,r)))*180/Math.PI;let c=Math.atan2(-a,-s)*180/Math.PI/15;c<0&&(c+=24),Cr.hidden=!1,pf.textContent=`${i.name} — constellation`,vf.textContent="Center RA",xf.textContent="Center Dec",Mf.textContent="Stars",mf.textContent=`${c.toFixed(1)}h`,gf.textContent=`${o>=0?"+":""}${o.toFixed(1)}°`,_f.textContent=`${i.stars.length} stars`,Rr(null);return}Cr.hidden=!0,Rr(null);return}const n=dr.get(ft),e=n?cy(n,le.t):null;if(!n||!e){Cr.hidden=!0,Rr(null);return}Cr.hidden=!1,pf.textContent=n.name,vf.textContent="Orbit period",xf.textContent="Distance",Mf.textContent="Peri / Apo",mf.textContent=ly(e.periodDays),gf.textContent=n.kind==="moon"?`${Hr(e.distanceKm)} from ${dr.get(n.parent??"")?.name??"parent"}`:`${Hr(e.distanceKm)} from Sun`,_f.textContent=`${Hr(e.perihelionKm)} / ${Hr(e.aphelionKm)}`,Rr(n)}function Rr(n){if(ll&&(ll.replaceChildren(),!!n))for(const e of hy(n)){const t=document.createElement("div");t.className="info-row";const i=document.createElement("span");i.textContent=e.label;const s=document.createElement("span");s.className="value",s.textContent=e.value,t.append(i,s),ll.appendChild(t)}}function td(n){or.value=String(n),le.setLogSpeed(n),cn(),sc(),qe()}or.addEventListener("input",()=>{td(parseFloat(or.value))});zo.addEventListener("click",()=>{le.setPaused(!le.isPaused),zo.textContent=le.isPaused?"Resume":"Pause",cn(),qe()});js.addEventListener("click",()=>{le.setReversed(!le.isReversed),js.textContent=le.isReversed?"Reverse ←":"Reverse →",js.classList.toggle("active",le.isReversed),cn(),sc(),qe()});tE.addEventListener("click",()=>{le.setDate(new Date),Ni(),cn(),qe()});function cc(){return!bi.hidden}function EE(n){Zs.textContent=n,Zs.classList.add("computing")}function bE(){Zs.classList.remove("computing")}function _r(){if(!cc())return;const n=parseInt(qp.value,10)||5;EE("Computing events…"),requestAnimationFrame(()=>{const e=le.toDate().getTime(),t=n*365.25*864e5,i=(e-t-gn)/864e5,s=(e+t-gn)/864e5,r=kp(i,s,{coarseStepDays:.2});TE(r)})}function TE(n){if(bE(),Zs.replaceChildren(),n.length===0){const t=document.createElement("p");t.className="ev-note",t.textContent="No events in this window.",Zs.appendChild(t);return}const e=document.createDocumentFragment();for(const t of n){const i=document.createElement("div");i.className="ev "+AE(t);const s=new Date(t.dateMs),r=s.getUTCFullYear(),a=String(s.getUTCMonth()+1).padStart(2,"0"),o=String(s.getUTCDate()).padStart(2,"0"),c=document.createElement("span");c.className="ev-date",c.textContent=`${r}-${a}-${o}`;const l=document.createElement("span");l.className="ev-what",l.textContent=t.title,l.title=t.detail;const u=document.createElement("span");u.className="ev-detail",u.textContent=t.detail,l.appendChild(u),i.append(c,l),i.addEventListener("click",()=>{le.setDate(new Date(t.dateMs)),Ni(),qe(),on.classList.remove("flash"),on.offsetWidth,on.classList.add("flash");const d=t.bodyId;if(d){const h=li(d);h&&ii(h,1.4,d)}}),e.appendChild(i)}Zs.appendChild(e)}function AE(n){switch(n.type){case"solar-eclipse":return"ecl-solar";case"lunar-eclipse":return"ecl-lunar";case"transit":return"transit";case"saturn-edge-on":return"saturn";default:return""}}lu.addEventListener("click",()=>{bi.hidden=!bi.hidden,lu.classList.toggle("active",!bi.hidden),bi.hidden||_r(),qe()});qp.addEventListener("change",()=>{_r()});Xr.addEventListener("change",()=>{SE()});const wE=mp(ua),DE=gp(),PE=15;let Zn=-1;function CE(n){const e=[];if(!n.trim()){for(const s of wE)e.push({c:!1,id:s.id,name:s.name,sub:s.sub});for(const s of DE.slice(0,PE))e.push({c:!0,id:s.id,name:s.name,sub:s.sub});return e}const t=c2(ua,n);for(const s of t)e.push({c:!1,id:s.id,name:s.name,sub:s.parentName?`moon of ${s.parentName}`:s.kind});const i=d2(n);for(const s of i)e.push({c:!0,id:s.id,name:s.name,sub:s.sub});return e}function em(n){return n.startsWith(Qr)?n.slice(Qr.length):dr.get(n)?.name??n}function us(n){Li.value=em(n)}function nd(){ti.hidden=!0,Zn=-1}function pu(){const n=ti.querySelectorAll(".fr");n.forEach((e,t)=>e.classList.toggle("active",t===Zn)),n[Zn]?.scrollIntoView({block:"nearest"})}function tm(n){const e=CE(n);ti.replaceChildren();const t=document.createDocumentFragment();if(e.length===0){const i=document.createElement("div");i.className="fr-empty",i.textContent="No matches",t.appendChild(i)}else for(const i of e){const s=document.createElement("div");s.className=i.c?"fr fr-const":"fr",s.innerHTML=`<span class="fr-name">${i.name}</span><span class="fr-sub">${i.sub}</span>`,s.addEventListener("click",()=>nm(i.id)),t.appendChild(s)}ti.appendChild(t),Zn=0,pu(),ti.hidden=!1}function nm(n){if(Li.value=em(n),nd(),Li.blur(),n.startsWith(Qr)){vE(n.slice(Qr.length));return}const e=n&&li(n)?n:"sun",t=li(e);t&&ii(t,1.4,e)}Li.addEventListener("focus",()=>tm(Li.value));Li.addEventListener("input",()=>{tm(Li.value)});Li.addEventListener("keydown",n=>{if(n.key==="Escape"){n.preventDefault(),ti.hidden?nm(""):nd();return}if(ti.hidden)return;const e=ti.querySelectorAll(".fr");if(n.key==="ArrowDown")n.preventDefault(),Zn=Math.min(e.length-1,Zn+1),pu();else if(n.key==="ArrowUp")n.preventDefault(),Zn=Math.max(0,Zn-1),pu();else if(n.key==="Enter"){n.preventDefault();const t=e[Zn];t&&t.click()}});document.addEventListener("pointerdown",n=>{!ti.hidden&&!n.target?.closest("#find-wrap")&&nd()});cr.addEventListener("change",()=>{Qn(),qe()});On.addEventListener("change",()=>{Qn(),qe()});lr.addEventListener("change",()=>{Qn(),qe()});Ks.addEventListener("change",()=>{pr=Ks.checked,Qn(),qe()});function RE(){cl=!cl;for(const n of N.bodies.values())n.atmosphereMesh&&(n.atmosphereMesh.visible=cl)}function Tf(){cn();const n=N.skybox.group,e=n.getObjectByName("milkyway-skybox"),t=n.getObjectByName("starfield"),i=n.getObjectByName("zodiacal-light");e&&(e.visible=Go),t&&(t.visible=Go),i&&(i.visible=iu)}function LE(){uo=(uo+1)%3;const n=ft||"sun",e=N.bodies.get(n);if(!e)return;const t=N.camera.aspect;if(uo===2){const c=li(n);c&&ii(c,.9,n);return}const i=e.radius??1,s=Math.max(i*2,.5),r=Op([e.worldPos.x,e.worldPos.y,e.worldPos.z],s,ci,t),a=Math.hypot(r.pos[0]-r.target[0],r.pos[1]-r.target[1],r.pos[2]-r.target[2]),o=uo===0?{pos:[r.target[0],r.target[1]+a,r.target[2]],target:r.target}:{pos:[r.target[0],r.target[1],r.target[2]+a],target:r.target};ii(o,.9,n)}function Af(n){const e=li(n);e&&ii(e,1.4,n)}function im(){ft="",Ii="",jt="",ar="",us(""),oc(),qe()}function lc(n){if(cn(),n.startsWith("jump-digit-")){const e=n.slice(11),t=oy(e,Xt,"sun");t&&Af(t);return}if(n.startsWith("jump-")){Af(n.slice(5));return}switch(n){case"pause":le.setPaused(!le.isPaused),zo.textContent=le.isPaused?"Resume":"Pause",qe();break;case"speed-up":case"speed-down":{const e=n==="speed-up"?.25:-.25,t=Math.max(-3,Math.min(2.5,parseFloat(or.value)+e));td(t);break}case"now":le.setDate(new Date),Ni(),qe();break;case"reverse":le.setReversed(!le.isReversed),js.textContent=le.isReversed?"Reverse ←":"Reverse →",js.classList.toggle("active",le.isReversed),sc(),qe();break;case"orbits":cr.checked=!cr.checked,Qn(),qe();break;case"labels":On.checked=!On.checked,Qn(),qe();break;case"belts":lr.checked=!lr.checked,Qn(),qe();break;case"figures":Ks.checked=!Ks.checked,pr=Ks.checked,Qn(),qe();break;case"milkyway":Go=!Go,Tf();break;case"zodiacal":iu=!iu,Tf();break;case"atmospheres":RE();break;case"post":ni=!ni,N.sunGlow.visible=ni;break;case"scale":fu(Qt===Hn?"visible":"real");break;case"camera-preset":LE();break;case"release":im();break;case"screenshot":Ur.click();break;case"palette":ur?ds():am();break}}function IE(){if(Ut||!lo||!qs)return;qs.hidden=!1,qs.setAttribute("aria-hidden","false"),lo.hidden=!1,lo.style.opacity="0",Ei&&(Ei.hidden=!1);const n=ra("system"),e={pos:[n.pos[0]*3,n.pos[1]*3,n.pos[2]*3]};N.camera.position.set(e.pos[0],e.pos[1],e.pos[2]),N.controls.target.set(0,0,0),Ut={leg:0,titleEl:lo},N.controls.enabled=!1,Mo=0,sm(0)}function sm(n){if(!Ut)return;const e=Vu[n],t=li(e.bodyId)??ra("system");n===0&&(t.pos=[t.pos[0]*e.zoom,t.pos[1]*e.zoom,t.pos[2]*e.zoom]),ft=e.bodyId,us(e.bodyId),Ii=e.bodyId,jt="",Ut.leg=n,N.controls.enabled=!1,Yt=ha([N.camera.position.x,N.camera.position.y,N.camera.position.z],[N.controls.target.x,N.controls.target.y,N.controls.target.z],t,e.duration,e.bodyId,N.camera.fov,ci)}let Mo=0;function HE(n){Ut?.titleEl&&(Mo+=n,Ut.titleEl.style.opacity=String(iy(Mo)),Mo>Wu+1.5&&ga(!1))}function UE(){Ut&&(Ut.leg<Vu.length-1?sm(Ut.leg+1):ga(!1))}function ga(n){if(!Ut)return;const e=Ut.titleEl;Ut=null;try{sessionStorage.setItem(Fp,"1")}catch{}if(qs&&(qs.hidden=!0,qs.setAttribute("aria-hidden","true")),!(ft==="earth")){const s=li("earth");if(s){ft="earth",us("earth"),Ii="earth",jt="",Yt=ha([N.camera.position.x,N.camera.position.y,N.camera.position.z],[N.controls.target.x,N.controls.target.y,N.controls.target.z],s,n?.6:1,"earth",N.camera.fov,ci),N.controls.enabled=!1,e&&(e.style.opacity="0",e.hidden=!0),Ei&&(Ei.hidden=!0),qe();return}}N.controls.enabled=!0,N.controls.update();const i=N.bodies.get(ft);i&&N.controls.target.copy(i.worldPos),e&&(e.style.opacity="0",e.hidden=!0),Ei&&(Ei.hidden=!0),qe()}for(const n of["pointerdown","wheel","touchstart"])Nt.addEventListener(n,()=>{Ut&&ga(!0)});window.addEventListener("keydown",n=>{if(!Ut||n.key==="/"||n.key==="?"||n.ctrlKey||n.metaKey||n.altKey)return;const e=n.target?.tagName;e==="INPUT"||e==="TEXTAREA"||ga(!0)});Ei&&Ei.addEventListener("click",()=>ga(!0));window.addEventListener("keydown",n=>{if(n.ctrlKey||n.metaKey||n.altKey)return;const e=n.target?.tagName;if(e==="INPUT"||e==="TEXTAREA")return;if(n.key==="/"||n.key==="?"){n.preventDefault(),ur?ds():am();return}if(n.key==="Escape"){ur?ds():im();return}const t=n.key.length===1?n.key.toLowerCase():n.key,i=ay(t);i&&(n.preventDefault(),lc(i))});function rm(n,e,t,i){if(!i)return!0;const s=i.toLowerCase();return n.includes(s)||e.toLowerCase().includes(s)||t.toLowerCase().includes(s)}function So(){if(!Or)return;Or.replaceChildren();const n=ko.trim();let e=0;for(let t=0;t<na.length;t++){const i=na[t];if(!rm(i.id,i.label,i.hint,n))continue;const s=document.createElement("div");s.className="pal-item"+(t===Si?" active":"");const r=document.createElement("span");r.className="pal-keys",r.textContent=i.keys.join(" ")||"•";const a=document.createElement("span");a.className="pal-label",a.textContent=i.label;const o=document.createElement("span");o.className="pal-hint",o.textContent=i.hint,s.append(r,a,o),s.addEventListener("click",()=>{lc(i.id),ds()}),Or.appendChild(s),e++}if(e===0){const t=document.createElement("div");t.className="pal-empty",t.textContent="No matching commands",Or.appendChild(t)}}function am(){!ta||!$i||!Or||(ur=!0,ko="",Si=0,ta.hidden=!1,$i.value="",na=ry(Xt.map(n=>({id:n.id,name:n.name}))).map(n=>({id:n.id,label:n.label,keys:n.keys,hint:n.hint})),So(),requestAnimationFrame(()=>$i.focus()))}function ds(){ta&&(ur=!1,ta.hidden=!0)}$i&&($i.addEventListener("input",()=>{ko=$i.value,Si=0,So()}),$i.addEventListener("keydown",n=>{if(n.stopPropagation(),n.key==="Escape")ds();else if(n.key==="ArrowDown")n.preventDefault(),Si=Math.min(na.length-1,Si+1),So();else if(n.key==="ArrowUp")n.preventDefault(),Si=Math.max(0,Si-1),So();else if(n.key==="Enter"){n.preventDefault();const e=ko.trim();let t=0;for(const i of na)if(rm(i.id,i.label,i.hint,e)){if(t===Si){lc(i.id),ds();break}t++}}}));document.addEventListener("pointerdown",n=>{ur&&ta&&!n.target?.closest("#palette")&&ds()});window.addEventListener("resize",()=>{cn(),N.camera.aspect=window.innerWidth/window.innerHeight,N.camera.updateProjectionMatrix(),N.renderer.setSize(window.innerWidth,window.innerHeight),N.post.setSize(window.innerWidth,window.innerHeight);const n=window.innerWidth<560;n!==cu&&(cu=n,ed())});const Be=py(window.location.href);Be.timeMs!=null&&le.setDate(new Date(Be.timeMs));if(Be.speedLog!=null){const n=Math.max(-3,Math.min(2.5,Be.speedLog));or.value=String(n),le.setLogSpeed(n)}Be.reversed!=null&&(le.setReversed(Be.reversed),js.textContent=Be.reversed?"Reverse ←":"Reverse →");Be.scale&&(Qt=Be.scale==="true"?Hn:ts);Be.orbits!=null&&(cr.checked=Be.orbits);Be.labels!=null&&(On.checked=Be.labels);new URL(window.location.href,"http://localhost").searchParams.get("post")==="0"&&(ni=!1);Be.belts!=null&&(lr.checked=Be.belts);Be.figures!=null&&(Ks.checked=Be.figures,pr=Be.figures);Be.paused!=null&&(le.setPaused(Be.paused),zo.textContent=Be.paused?"Resume":"Pause");Be.eventsOpen!=null&&(bi.hidden=!Be.eventsOpen,lu.classList.toggle("active",Be.eventsOpen));bi.hidden||_r();const yo=Be.constellation&&kt.some(n=>n.name===Be.constellation)?Be.constellation:null;Be.follow&&dr.has(Be.follow)?(us(Be.follow),ft=Be.follow,Ii=Be.follow):yo||(us("sun"),ft="sun",Ii="sun");yo&&(jt=yo,us(`const:${yo}`),ar="");function om(){return{timeMs:le.toDate().getTime(),speedLog:parseFloat(or.value),reversed:le.isReversed,follow:ft||void 0,constellation:jt||void 0,scale:Qt===Hn?"true":"visible",orbits:cr.checked,labels:On.checked,belts:lr.checked,figures:pr,paused:le.isPaused,eventsOpen:!bi.hidden,cam:{pos:[N.camera.position.x,N.camera.position.y,N.camera.position.z],target:[N.controls.target.x,N.controls.target.y,N.controls.target.z]}}}let hl;function qe(){hl===void 0&&(hl=setTimeout(()=>{hl=void 0,window.history.replaceState(null,"",Bp(window.location.href,om()))},300))}co.addEventListener("click",async()=>{const n=Bp(window.location.href,om());window.history.replaceState(null,"",n);try{await navigator.clipboard.writeText(n),co.textContent="Link copied ✓"}catch{co.textContent="Link in address bar"}setTimeout(()=>{co.textContent="Copy share link"},1500)});Ur.addEventListener("click",async()=>{const n=N.renderer.domElement,e=le.toDate(),t=c=>String(c).padStart(2,"0"),i=`${e.getUTCFullYear()}-${t(e.getUTCMonth()+1)}-${t(e.getUTCDate())}T${t(e.getUTCHours())}${t(e.getUTCMinutes())}Z`,s=Ri&&On.checked?Ri.canvas:null;let r=n;if(s){r=document.createElement("canvas"),r.width=n.width,r.height=n.height;const c=r.getContext("2d");c.drawImage(n,0,0),c.drawImage(s,0,0,n.width,n.height)}const a=await new Promise(c=>r.toBlob(l=>c(l),"image/png"));if(!a){Ur.textContent="Export failed";return}const o=document.createElement("a");o.href=URL.createObjectURL(a),o.download=`solar-system-${i}.png`,o.click(),setTimeout(()=>URL.revokeObjectURL(o.href),5e3),Ur.textContent="Saved ✓",setTimeout(()=>{Ur.textContent="Save screenshot"},1500)});gE(Qt);N.sunGlow.visible=ni;Ri=zS(Nt);Ri.setVisible(On.checked);xE();$u();Be.cam&&(N.camera.position.set(...Be.cam.pos),N.controls.target.set(...Be.cam.target),N.controls.update());sc();ed();const wi=new URLSearchParams(window.location.search).get("cmd")?.toLowerCase()??null,cm=new Set(Xu.map(n=>n.id));cm.add("palette");const lm=wi!=null&&/^[0-9]$/.test(wi),um=wi!=null&&(lm||cm.has(wi));wi&&um&&lc(lm?`jump-digit-${wi}`:wi);{const n=window.matchMedia("(prefers-reduced-motion: reduce)").matches,e=new URLSearchParams(window.location.search).get("intro"),t=!!Be.follow||!!Be.constellation||!!Be.cam||!!(wi&&um);let i=!1;try{i=sessionStorage.getItem(Fp)==="1"}catch{}ny(n,e,t,i)&&IE()}window.__solar={get scene(){return N.scene},get camera(){return N.camera},get controls(){return N.controls},get renderer(){return N.renderer},get labelLayer(){return Ri},get bodies(){return N.bodies},satelliteExtentScene:n=>Np(n,Qt),clock:le};const Wo=new pp,Xo=new ae;let dm=0,hm=0,id=!1,wf=0,sd=!1;function fm(){const n=[];for(const e of N.bodies.values())n.push(e.mesh);return n}function NE(n,e){Nr.innerHTML=`${n}${e?`<span class="sub"> ${e}</span>`:""}`,Nr.style.left=`${dm}px`,Nr.style.top=`${hm}px`,Nr.classList.add("show")}function Yo(){Nr.classList.remove("show")}function OE(){if(!id||sd){Yo();return}Wo.setFromCamera(Xo,N.camera);const n=Wo.intersectObjects(fm(),!1);if(n.length>0){const e=n[0].object.userData.id,t=e?dr.get(e):void 0;if(t){const i=t.kind==="moon"?`moon of ${dr.get(t.parent??"")?.name??""}`:t.kind.charAt(0).toUpperCase()+t.kind.slice(1);NE(t.name,i);return}}Yo()}Nt.addEventListener("pointermove",n=>{id=!0,dm=n.clientX,hm=n.clientY,Xo.set(n.clientX/window.innerWidth*2-1,-(n.clientY/window.innerHeight)*2+1);const e=performance.now();e-wf<50||(wf=e,OE())});Nt.addEventListener("pointerleave",()=>{id=!1,Yo()});Nt.addEventListener("pointerdown",()=>{sd=!0,Yo()});window.addEventListener("pointerup",()=>{sd=!1});let pm=0,mm=0;Nt.addEventListener("pointerdown",n=>{pm=n.clientX,mm=n.clientY});Nt.addEventListener("pointerup",n=>{if(Eo)return;if(hr){hr=!1;return}if(n.pointerType==="touch"&&At.size>1||n.button===2||Math.hypot(n.clientX-pm,n.clientY-mm)>6)return;const e=Nt.getBoundingClientRect();Xo.set((n.clientX-e.left)/e.width*2-1,-((n.clientY-e.top)/e.height)*2+1),Wo.setFromCamera(Xo,N.camera);const t=Wo.intersectObjects(fm(),!1);if(t.length>0){const i=t[0].object.userData.id,s=i?li(i):null;s&&ii(s,1.4,i)}});let Zt=null,hr=!1;function rd(){Zu.classList.remove("scrubbing"),mr.classList.remove("hot"),Ju.classList.remove("hot"),si=null,Fr.clear(),aa=[],su.replaceChildren(),jp.style.width="0%",Kp.style.left="0%",od(),_m(),is.classList.remove("visible")}let si=null;const Fr=new Set;let _a=0,va=365,aa=[];function FE(){return new Date(gn+le.t*864e5).getUTCFullYear()}function ad(){is.classList.contains("visible")||is.classList.add("visible")}function gm(n){Kp.style.left=`${n*100}%`,jp.style.width=`${n*100}%`}function fl(n){const{span0Days:e,spanLenDays:t}=Wp(n);_a=e,va=t;const i=Xp(n)?Yp(n).events:[],{markers:s,overflow:r,caretFrac:a}=ic(e,t,i,le.t);ru.textContent=String(n),su.replaceChildren();const o=ma.clientWidth||window.innerWidth,l=Math.max(1,o-2*12),u=document.createDocumentFragment();aa=[];for(const d of s){const h=document.createElement("span");h.className="tl-event",h.style.left=`${d.frac*100}%`,h.textContent=d.emoji,h.title=d.title,u.appendChild(h),aa.push({day:d.frac*t,x:d.frac*l,emoji:d.emoji,title:d.title})}if(r>0){const d=document.createElement("span");d.className="tl-overflow",d.textContent=`+${r}`,u.appendChild(d)}su.appendChild(u),gm(a)}const zE=0,BE=120,kE=24,GE=Uy(365);function od(){Os.classList.remove("show")}function _m(){au.classList.remove("show"),xo.getContext("2d")?.clearRect(0,0,xo.width,xo.height)}function VE(n){const e=xo,t=window.devicePixelRatio||1,i=Wt*2;(e.width!==i*t||e.height!==i*t)&&(e.width=Math.round(i*t),e.height=Math.round(i*t));const s=e.getContext("2d");if(!s)return;s.setTransform(t,0,0,t,0,0),s.clearRect(0,0,i,i);const r=ma.clientWidth||window.innerWidth,a=12,o=Math.max(1,r-2*a),c=ic(_a,va,[],le.t).caretFrac,l=n-a;s.lineCap="round",s.strokeStyle="rgba(160, 190, 220, 0.5)",s.lineWidth=20,s.beginPath(),s.moveTo(2,Wt),s.lineTo(i-2,Wt),s.stroke();for(const u of GE){const d=u.frac*o-l,h=ao(d,0);if(!h)continue;const f=Wt+h.x;s.strokeStyle="rgba(120, 150, 200, 0.55)",s.lineWidth=Math.max(1,h.scale),s.beginPath(),s.moveTo(f,Wt-4.5*h.scale),s.lineTo(f,Wt+4.5*h.scale),s.stroke();const g=ao(d,9);g&&(s.save(),s.translate(Wt+g.x,Wt+g.y),s.rotate(Math.PI/4),s.scale(g.scale,g.scale),s.fillStyle="#7d90ad",s.font="10px system-ui, sans-serif",s.fillText(u.abbr,0,9),s.restore())}for(const u of aa){const d=u.x-l,h=ao(d,0);h&&(s.save(),s.translate(Wt+h.x,Wt+h.y),s.scale(h.scale,h.scale),s.font="13px system-ui, sans-serif",s.textAlign="center",s.textBaseline="middle",s.fillText(u.emoji,0,0),s.restore())}if(is.classList.contains("visible")){const u=c*o-l,d=ao(u,0);if(d){const h=Wt+d.x;s.fillStyle="#57c785",s.shadowColor="rgba(87, 199, 133, 0.7)",s.shadowBlur=6*d.scale;const f=Math.max(2,3*d.scale);s.fillRect(h-f/2,Wt-7.5*d.scale,f,15*d.scale),s.shadowBlur=0}}}function WE(){const n=ma.clientWidth||window.innerWidth,e=12,t=Math.max(1,n-2*e),i=ic(_a,va,[],le.t).caretFrac;return e+i*t}function vm(n){if(si===null)return;const e=ma.getBoundingClientRect();if(e.width<2)return;const t=e.width,i=!!(Zt?.movedX||ui?.live),s=Math.max(0,Math.min(t,n-e.left)),r=lf(i?WE():s,t),a=r-12,o=Ny(aa,a,kE);if(o){const l=cf(si,o.day);Os.innerHTML=`<span class="tl-tip-date">${l}</span>${o.emoji} ${o.title}`;const u=Zu.getBoundingClientRect(),d=Os.offsetWidth,h=u.right-4,f=Math.max(12,h-d);Os.style.left=`${f}px`,Os.style.top=`${u.bottom+6}px`,Os.classList.add("show")}else od();au.style.left=`${r-Wt}px`,VE(r);const c=i?Math.max(0,le.t-_a):r/t*va;iE.textContent=cf(si,c),au.classList.add("show")}function XE(){si!==null&&(uc(),ad(),vm(Number.POSITIVE_INFINITY))}window.addEventListener("pointermove",n=>{if(n.pointerType!=="mouse")return;const e=ma.getBoundingClientRect();n.clientY>=e.top-zE&&n.clientY<=e.bottom+BE?(uc(),is.classList.contains("hover")||is.classList.add("hover"),vm(n.clientX)):(od(),_m(),is.classList.remove("hover"))});function uc(){const n=FE();if(!(n===si&&!Fr.has(n))){if(si=n,Xp(n)){fl(n);return}Fr.has(n)||(Fr.add(n),fl(n),requestAnimationFrame(()=>{Fr.delete(n),Yp(n),si===n&&fl(n)}))}}function YE(){if(si===null)return;const{caretFrac:n}=ic(_a,va,[],le.t);gm(n)}function xm(n,e,t){let i=!1;const s=!n.movedX&&Math.abs(e)>6,r=!n.movedY&&Math.abs(t)>4;return s&&(n.movedX=!0),r&&(n.movedY=!0),(s||r)&&Zu.classList.add("scrubbing"),n.movedX&&(mr.classList.add("hot"),le.setDate(new Date(gn+Py(n.startDays,n.span0Days,n.spanLenDays,e)*864e5)),i=!0),n.movedY&&(Ju.classList.add("hot"),td(Cy(n.startLog,t)),i=!0),i}Nt.addEventListener("contextmenu",n=>n.preventDefault());Nt.addEventListener("pointerdown",n=>{if(hr=!1,n.pointerType!=="mouse"||n.button!==2)return;const e=new Date(gn+le.t*864e5).getUTCFullYear(),t=Gp(e);Zt={startX:n.clientX,startY:n.clientY,startDays:le.t,startLog:le.getLogSpeed(),movedX:!1,movedY:!1,span0Days:t.span0Days,spanLenDays:t.spanLenDays},le.beginScrub()});window.addEventListener("pointermove",n=>{if(!Zt||n.pointerType!=="mouse"||!(n.buttons&4))return;const e=n.clientX-Zt.startX,t=n.clientY-Zt.startY;xm(Zt,e,t)&&(sa=performance.now(),qe()),(Zt.movedX||Zt.movedY)&&(ad(),uc())});window.addEventListener("pointerup",n=>{if(!Zt||n.pointerType!=="mouse"||n.button!==2)return;const e=Zt;Zt=null,le.endScrub(),(e.movedX||e.movedY)&&(Ni(),hr=!0),rd()});window.addEventListener("pointercancel",n=>{!Zt||n.pointerType!=="mouse"||(Zt=null,le.endScrub(),rd())});const At=new Map;let ui=null,Eo=!1;function Mm(n){const e=ui;!e||e.ended||(e.ended=!0,le.endScrub(),n&&(Ni(),hr=!0),rd())}Nt.addEventListener("pointerdown",n=>{if(n.pointerType!=="touch"||At.size>=4||(At.set(n.pointerId,{x:n.clientX,y:n.clientY}),At.size!==3))return;const e=[...At.values()],t=(e[0].x+e[1].x+e[2].x)/3,i=(e[0].y+e[1].y+e[2].y)/3,s=new Date(gn+le.t*864e5).getUTCFullYear(),r=Gp(s);ui={startX:t,startY:i,startDays:le.t,startLog:le.getLogSpeed(),movedX:!1,movedY:!1,live:!1,ended:!1,span0Days:r.span0Days,spanLenDays:r.spanLenDays},le.beginScrub()});Nt.addEventListener("pointermove",n=>{if(n.pointerType!=="touch"||!At.has(n.pointerId))return;At.set(n.pointerId,{x:n.clientX,y:n.clientY});const e=ui;if(!e||e.ended||At.size<3)return;const t=[...At.values()],i=(t[0].x+t[1].x+t[2].x)/3,s=(t[0].y+t[1].y+t[2].y)/3;xm(e,i-e.startX,s-e.startY)&&(e.live=!0,sa=performance.now(),qe()),(e.movedX||e.movedY)&&(ad(),uc(),XE())});window.addEventListener("pointerup",n=>{if(n.pointerType!=="touch"||Eo||At.size===0)return;const e=At.size>=3;At.delete(n.pointerId);const t=ui;if(t&&e&&!t.ended&&(hr=!0,Mm(t.live),ui=null,At.size===2)){const i=[...At.keys()][0],s=At.get(i);Eo=!0,Nt.dispatchEvent(new PointerEvent("pointerup",{pointerId:i,pointerType:"touch",clientX:s.x,clientY:s.y})),Nt.dispatchEvent(new PointerEvent("pointerdown",{pointerId:i,pointerType:"touch",clientX:s.x,clientY:s.y})),Eo=!1}});window.addEventListener("pointercancel",n=>{if(n.pointerType!=="touch")return;At.delete(n.pointerId);const e=ui;e&&!e.ended&&At.size<3&&Mm(e.live),e&&At.size<3&&(ui=null)});function jE(){if(!Ri||!On.checked)return;const n=N.camera,e=n.position,t=e.x,i=e.y,s=e.z,r=Rp(e.length()),a=jt?kt.findIndex(c=>c.name===jt):-1,o=[];for(let c=0;c<kt.length;c++){const l=Fo[c];if(zu(l)*r<=eu)continue;const u=Zy[c],d=t*u[0]+i*u[1]+s*u[2],h=Math.sqrt(vt*vt+(t*t+i*i+s*s)-2*vt*d);ol.set(e,ff.set(u[0]*vt-t,u[1]*vt-i,u[2]*vt-s).normalize());let f=!1;const g=ff;for(const _ of N.bodies.values()){if(!_.mesh.visible)continue;const m=_.worldPos,p=m.x-t,v=m.y-i,x=m.z-s,E=Math.sqrt(p*p+v*v+x*x);if(E<1e-6)continue;const R=1/E,T=p*R,D=v*R,H=x*R,b=D*g.z-H*g.y,S=H*g.x-T*g.z,C=T*g.y-D*g.x,k=Math.sqrt(Math.min(1,b*b+S*S+C*C)),O=Math.max(1,_.frameExtent>0?_.frameExtent/2:_.sceneRadius);if(k>(O+2)/E)continue;ol.far=E*2;const Y=ol.intersectObject(_.mesh,!1);if(Y.length>0&&Y[0].distance<h){f=!0;break}}o.push({name:kt[c].name,dir:u,emphasis:l,emphasized:a>=0?c===a:!1,occluded:f})}GS(Ri,n,o,r,window.innerWidth,window.innerHeight)}function Sm(){if(requestAnimationFrame(Sm),Qu)return;const n=performance.now(),e=Math.min(.1,(n-uu)/1e3);uu=n,yf||(jn.x=N.camera.position.x,jn.y=N.camera.position.y,jn.z=N.camera.position.z,Kn.x=N.controls.target.x,Kn.y=N.controls.target.y,Kn.z=N.controls.target.z,yf=!0),Ut&&HE(e),le.tick(e);const t=le.t-Sf;Sf=le.t;let i=Qt;if(Ge){Ge.dir!==0&&(Ge.p=Math.min(1,Math.max(0,Ge.p+Ge.dir*e/fE)),(Ge.dir===1&&Ge.p>=1||Ge.dir===-1&&Ge.p<=0)&&mE());const o=Ge.dir===0?1:Gu(Ge.p);i=KM(ts,Hn,o),DS(N,o);for(const c of N.bodies.values())c.orbit&&PS(c.orbit,i,c.parent?c.def.id:null);Ge.dir===0?Ge.reframed||(Ge.reframed=!0,Yt=ha([N.camera.position.x,N.camera.position.y,N.camera.position.z],[N.controls.target.x,N.controls.target.y,N.controls.target.z],ra("system"),1.2,null,N.camera.fov,ci),N.controls.enabled=!1):Yt&&Ge.reframed&&(Yt=null,N.controls.enabled=!0,N.controls.update())}{const o=performance.now();if(o-sa>250){sa=o;const c=N.bodies.get("moon");c?.orbit&&Up(c.orbit,le.t,i)}}if(Lp(N,le.t,i),le.isPaused||Hp(N,le.t,i,N.camera.position.length()),CS(N,t),Yt){N.controls.enabled=!1;let o;if(Yt.followId){const u=N.bodies.get(Yt.followId);u&&(o=[u.worldPos.x,u.worldPos.y,u.worldPos.z])}const c=KS(Yt,e,o),l=c.target;if(N.controls.target.set(l[0],l[1],l[2]),N.camera.position.set(l[0]+c.offset[0],l[1]+c.offset[1],l[2]+c.offset[2]),Math.abs(N.camera.fov-c.fov)>.001&&(N.camera.fov=c.fov,N.camera.updateProjectionMatrix()),N.camera.lookAt(l[0],l[1],l[2]),c.done){if(Yt=null,Ut)UE();else if(No)No=!1,Yy();else if(N.controls.enabled=!0,N.controls.update(),ft){const u=N.bodies.get(ft);u&&N.controls.target.copy(u.worldPos)}qe()}}else if(Ai)jy(e);else if(ft){const o=N.bodies.get(ft),c=o&&ia.has(ft)?N.bodies.get(ia.get(ft)):o;c&&N.controls.target.lerp(c.worldPos,.2),N.controls.update()}else N.controls.update();{const o=N.camera.position,c=N.controls.target;if(ul=Math.abs(o.x-jn.x)+Math.abs(o.y-jn.y)+Math.abs(o.z-jn.z)+Math.abs(c.x-Kn.x)+Math.abs(c.y-Kn.y)+Math.abs(c.z-Kn.z)>1e-4,le.isPaused&&ul&&wS(N,i,o.length()),!du&&fy({paused:le.isPaused,cameraMoving:ul,scrubbing:!!(Zt?.movedX||ui?.live),flightActive:Yt!==null,morphActive:Ge!==null,skyTourActive:Ai!==null,introActive:Ut!==null}))return;jn.x=o.x,jn.y=o.y,jn.z=o.z,Kn.x=c.x,Kn.y=c.y,Kn.z=c.z,du=!1}Jy(),Qy(n),$y(n),IS(N,Ii,n/1e3);const a=N.camera.position.length()<=170;if(a!==N.sunLight.castShadow&&(N.sunLight.castShadow=a),N.skybox.update(N.camera),ni?N.post.composer.render():N.renderer.render(N.scene,N.camera),jE(),ed(),ls){const o=le.toDate();if(o.getUTCFullYear()===Tn&&o.getUTCMonth()===Un){const c=o.getUTCDate();c!==ou&&(ou=c,gr())}}YE(),oc()}requestAnimationFrame(Sm);Nt.addEventListener("webglcontextlost",n=>{n.preventDefault(),Qu=!0,Bo.hidden=!1,Bo.classList.add("show")});Nt.addEventListener("webglcontextrestored",()=>{Qu=!1,cn(),Bo.hidden=!0,Bo.classList.remove("show"),N.renderer.setSize(window.innerWidth,window.innerHeight),uu=performance.now()});nE.addEventListener("click",()=>window.location.reload());
