...
export const FIGURE_FITS: FigureFit[] = [
  ...
  // Plan-011 batch 3a — 32 constellations cropped from the multi-constellation
  // 1801 plates + the four dedicated 1782 Coelum Stellatum sheets (full
  // star-chart extractions). Aspect = actual PNG; offsets from the star-
  // pattern fitter (verified D-test).
  { constellation: 'Hydra', aspect: 1.0, sizeDeg: 70, offsetRAHours: -0.25 },
  {
  ...
  { constellation: 'Hercules', aspect: 1.0, sizeDeg: 46.7 },
  { constellation: 'Ursa Minor', aspect: 1.0, sizeDeg: 23.6, offsetDecDeg: -2 },
  { constellation: 'Cepheus', aspect: 1.0, sizeDeg: 27.3, offsetDecDeg: -2 },
  {
  ...
  { constellation: 'Libra', aspect: 1.0, sizeDeg: 26.3, offsetDecDeg: -1 },
  { constellation: 'Auriga', aspect: 1.0, sizeDeg: 33, offsetRAHours: -0.25 },
  { constellation: 'Capricornus', aspect: 1.0, sizeDeg: 27.3 },
  { constellation: 'Lepus', aspect: 1.0, sizeDeg: 20.2 },
  { constellation: 'Lupus', aspect: 1.0, sizeDeg: 24.7, offsetDecDeg: +1 },
  { constellation: 'Grus', aspect: 1.0, sizeDeg: 24.1 },
  { constellation: 'Cassiopeia', aspect: 1.001, sizeDeg: 16.6 },
  { constellation: 'Sextans', aspect: 1.0, sizeDeg: 15, offsetDecDeg: +1 },
  { constellation: 'Crater', aspect: 1.001, sizeDeg: 17.9 },
  { constellation: 'Lacerta', aspect: 1.001, sizeDeg: 18.2, offsetDecDeg: +1 },
  { constellation: 'Leo Minor', aspect: 1.0, sizeDeg: 20.3 },
  { constellation: 'Corvus', aspect: 1.0, sizeDeg: 12 },
  { constellation: 'Corona Borealis', aspect: 1.0, sizeDeg: 12, offsetDecDeg: -1 },
  { constellation: 'Lyra', aspect: 1.0, sizeDeg: 12, offsetDecDeg: +1 },
  { constellation: 'Scutum', aspect: 1.0, sizeDeg: 13.5 },
  { constellation: 'Canes Venatici', aspect: 1.0, sizeDeg: 12 },
  { constellation: 'Triangulum', aspect: 1.0, sizeDeg: 12, offsetDecDeg: +1 },
  { constellation: 'Norma', aspect: 1.0, sizeDeg: 12 },
  { constellation: 'Vulpecula', aspect: 1.0, sizeDeg: 12 },
  { constellation: 'Telescopium', aspect: 0.999, sizeDeg: 12 },
  { constellation: 'Delphinus', aspect: 1.0, sizeDeg: 12, offsetDecDeg: +1 },
  { constellation: 'Equuleus', aspect: 1.0, sizeDeg: 12, offsetDecDeg: +1 },
  { constellation: 'Sagitta', aspect: 1.0, sizeDeg: 12 },
];
